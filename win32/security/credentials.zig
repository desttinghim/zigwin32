...
pub const CRED_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(CRED_FLAGS, (if (o.PASSWORD_FOR_CERT == 1) @enumToInt(CRED_FLAGS.PASSWORD_FOR_CERT) else 0) | (if (o.PROMPT_NOW == 1) @enumToInt(CRED_FLAGS.PROMPT_NOW) else 0) | (if (o.USERNAME_TARGET == 1) @enumToInt(CRED_FLAGS.USERNAME_TARGET) else 0) | (if (o.OWF_CRED_BLOB == 1) @enumToInt(CRED_FLAGS.OWF_CRED_BLOB) else 0) | (if (o.REQUIRE_CONFIRMATION == 1) @enumToInt(CRED_FLAGS.REQUIRE_CONFIRMATION) else 0) | (if (o.WILDCARD_MATCH == 1) @enumToInt(CRED_FLAGS.WILDCARD_MATCH) else 0) | (if (o.VSM_PROTECTED == 1) @enumToInt(CRED_FLAGS.VSM_PROTECTED) else 0) | (if (o.NGC_CERT == 1) @enumToInt(CRED_FLAGS.NGC_CERT) else 0) | (if (o.VALID_FLAGS == 1) @enumToInt(CRED_FLAGS.VALID_FLAGS) else 0) | (if (o.VALID_INPUT_FLAGS == 1) @enumToInt(CRED_FLAGS.VALID_INPUT_FLAGS) else 0));
    }
};
...
pub const CREDUI_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(CREDUI_FLAGS, (if (o.ALWAYS_SHOW_UI == 1) @enumToInt(CREDUI_FLAGS.ALWAYS_SHOW_UI) else 0) | (if (o.COMPLETE_USERNAME == 1) @enumToInt(CREDUI_FLAGS.COMPLETE_USERNAME) else 0) | (if (o.DO_NOT_PERSIST == 1) @enumToInt(CREDUI_FLAGS.DO_NOT_PERSIST) else 0) | (if (o.EXCLUDE_CERTIFICATES == 1) @enumToInt(CREDUI_FLAGS.EXCLUDE_CERTIFICATES) else 0) | (if (o.EXPECT_CONFIRMATION == 1) @enumToInt(CREDUI_FLAGS.EXPECT_CONFIRMATION) else 0) | (if (o.GENERIC_CREDENTIALS == 1) @enumToInt(CREDUI_FLAGS.GENERIC_CREDENTIALS) else 0) | (if (o.INCORRECT_PASSWORD == 1) @enumToInt(CREDUI_FLAGS.INCORRECT_PASSWORD) else 0) | (if (o.KEEP_USERNAME == 1) @enumToInt(CREDUI_FLAGS.KEEP_USERNAME) else 0) | (if (o.PASSWORD_ONLY_OK == 1) @enumToInt(CREDUI_FLAGS.PASSWORD_ONLY_OK) else 0) | (if (o.PERSIST == 1) @enumToInt(CREDUI_FLAGS.PERSIST) else 0) | (if (o.REQUEST_ADMINISTRATOR == 1) @enumToInt(CREDUI_FLAGS.REQUEST_ADMINISTRATOR) else 0) | (if (o.REQUIRE_CERTIFICATE == 1) @enumToInt(CREDUI_FLAGS.REQUIRE_CERTIFICATE) else 0) | (if (o.REQUIRE_SMARTCARD == 1) @enumToInt(CREDUI_FLAGS.REQUIRE_SMARTCARD) else 0) | (if (o.SERVER_CREDENTIAL == 1) @enumToInt(CREDUI_FLAGS.SERVER_CREDENTIAL) else 0) | (if (o.SHOW_SAVE_CHECK_BOX == 1) @enumToInt(CREDUI_FLAGS.SHOW_SAVE_CHECK_BOX) else 0) | (if (o.USERNAME_TARGET_CREDENTIALS == 1) @enumToInt(CREDUI_FLAGS.USERNAME_TARGET_CREDENTIALS) else 0) | (if (o.VALIDATE_USERNAME == 1) @enumToInt(CREDUI_FLAGS.VALIDATE_USERNAME) else 0));
    }
};
...
pub const CRED_ENUMERATE_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(CRED_ENUMERATE_FLAGS, (if (o.S == 1) @enumToInt(CRED_ENUMERATE_FLAGS.S) else 0));
    }
};
...
pub const CREDUIWIN_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(CREDUIWIN_FLAGS, (if (o.GENERIC == 1) @enumToInt(CREDUIWIN_FLAGS.GENERIC) else 0) | (if (o.CHECKBOX == 1) @enumToInt(CREDUIWIN_FLAGS.CHECKBOX) else 0) | (if (o.AUTHPACKAGE_ONLY == 1) @enumToInt(CREDUIWIN_FLAGS.AUTHPACKAGE_ONLY) else 0) | (if (o.IN_CRED_ONLY == 1) @enumToInt(CREDUIWIN_FLAGS.IN_CRED_ONLY) else 0) | (if (o.ENUMERATE_ADMINS == 1) @enumToInt(CREDUIWIN_FLAGS.ENUMERATE_ADMINS) else 0) | (if (o.ENUMERATE_CURRENT_USER == 1) @enumToInt(CREDUIWIN_FLAGS.ENUMERATE_CURRENT_USER) else 0) | (if (o.SECURE_PROMPT == 1) @enumToInt(CREDUIWIN_FLAGS.SECURE_PROMPT) else 0) | (if (o.PREPROMPTING == 1) @enumToInt(CREDUIWIN_FLAGS.PREPROMPTING) else 0) | (if (o.PACK_32_WOW == 1) @enumToInt(CREDUIWIN_FLAGS.PACK_32_WOW) else 0));
    }
};
...
pub const CRED_PACK_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(CRED_PACK_FLAGS, (if (o.PROTECTED_CREDENTIALS == 1) @enumToInt(CRED_PACK_FLAGS.PROTECTED_CREDENTIALS) else 0) | (if (o.WOW_BUFFER == 1) @enumToInt(CRED_PACK_FLAGS.WOW_BUFFER) else 0) | (if (o.GENERIC_CREDENTIALS == 1) @enumToInt(CRED_PACK_FLAGS.GENERIC_CREDENTIALS) else 0) | (if (o.ID_PROVIDER_CREDENTIALS == 1) @enumToInt(CRED_PACK_FLAGS.ID_PROVIDER_CREDENTIALS) else 0));
    }
};
...
pub const KeyCredentialManagerOperationErrorStates = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(KeyCredentialManagerOperationErrorStates, (if (o.None == 1) @enumToInt(KeyCredentialManagerOperationErrorStates.None) else 0) | (if (o.DeviceJoinFailure == 1) @enumToInt(KeyCredentialManagerOperationErrorStates.DeviceJoinFailure) else 0) | (if (o.TokenFailure == 1) @enumToInt(KeyCredentialManagerOperationErrorStates.TokenFailure) else 0) | (if (o.CertificateFailure == 1) @enumToInt(KeyCredentialManagerOperationErrorStates.CertificateFailure) else 0) | (if (o.RemoteSessionFailure == 1) @enumToInt(KeyCredentialManagerOperationErrorStates.RemoteSessionFailure) else 0) | (if (o.PolicyFailure == 1) @enumToInt(KeyCredentialManagerOperationErrorStates.PolicyFailure) else 0) | (if (o.HardwareFailure == 1) @enumToInt(KeyCredentialManagerOperationErrorStates.HardwareFailure) else 0) | (if (o.PinExistsFailure == 1) @enumToInt(KeyCredentialManagerOperationErrorStates.PinExistsFailure) else 0));
    }
};
