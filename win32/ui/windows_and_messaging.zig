...
pub const SCROLLBAR_CONSTANTS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(SCROLLBAR_CONSTANTS, (if (o.CTL == 1) @enumToInt(SCROLLBAR_CONSTANTS.CTL) else 0) | (if (o.HORZ == 1) @enumToInt(SCROLLBAR_CONSTANTS.HORZ) else 0) | (if (o.VERT == 1) @enumToInt(SCROLLBAR_CONSTANTS.VERT) else 0) | (if (o.BOTH == 1) @enumToInt(SCROLLBAR_CONSTANTS.BOTH) else 0));
    }
};
...
pub const IMAGE_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(IMAGE_FLAGS, (if (o.CREATEDIBSECTION == 1) @enumToInt(IMAGE_FLAGS.CREATEDIBSECTION) else 0) | (if (o.DEFAULTCOLOR == 1) @enumToInt(IMAGE_FLAGS.DEFAULTCOLOR) else 0) | (if (o.DEFAULTSIZE == 1) @enumToInt(IMAGE_FLAGS.DEFAULTSIZE) else 0) | (if (o.LOADFROMFILE == 1) @enumToInt(IMAGE_FLAGS.LOADFROMFILE) else 0) | (if (o.LOADMAP3DCOLORS == 1) @enumToInt(IMAGE_FLAGS.LOADMAP3DCOLORS) else 0) | (if (o.LOADTRANSPARENT == 1) @enumToInt(IMAGE_FLAGS.LOADTRANSPARENT) else 0) | (if (o.MONOCHROME == 1) @enumToInt(IMAGE_FLAGS.MONOCHROME) else 0) | (if (o.SHARED == 1) @enumToInt(IMAGE_FLAGS.SHARED) else 0) | (if (o.VGACOLOR == 1) @enumToInt(IMAGE_FLAGS.VGACOLOR) else 0) | (if (o.COPYDELETEORG == 1) @enumToInt(IMAGE_FLAGS.COPYDELETEORG) else 0) | (if (o.COPYFROMRESOURCE == 1) @enumToInt(IMAGE_FLAGS.COPYFROMRESOURCE) else 0) | (if (o.COPYRETURNORG == 1) @enumToInt(IMAGE_FLAGS.COPYRETURNORG) else 0));
    }
};
...
pub const MSG_WAIT_FOR_MULTIPLE_OBJECTS_EX_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(MSG_WAIT_FOR_MULTIPLE_OBJECTS_EX_FLAGS, (if (o.NONE == 1) @enumToInt(MSG_WAIT_FOR_MULTIPLE_OBJECTS_EX_FLAGS.NONE) else 0) | (if (o.ALERTABLE == 1) @enumToInt(MSG_WAIT_FOR_MULTIPLE_OBJECTS_EX_FLAGS.ALERTABLE) else 0) | (if (o.INPUTAVAILABLE == 1) @enumToInt(MSG_WAIT_FOR_MULTIPLE_OBJECTS_EX_FLAGS.INPUTAVAILABLE) else 0) | (if (o.WAITALL == 1) @enumToInt(MSG_WAIT_FOR_MULTIPLE_OBJECTS_EX_FLAGS.WAITALL) else 0));
    }
};
...
pub const SCROLLINFO_MASK = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(SCROLLINFO_MASK, (if (o.ALL == 1) @enumToInt(SCROLLINFO_MASK.ALL) else 0) | (if (o.DISABLENOSCROLL == 1) @enumToInt(SCROLLINFO_MASK.DISABLENOSCROLL) else 0) | (if (o.PAGE == 1) @enumToInt(SCROLLINFO_MASK.PAGE) else 0) | (if (o.POS == 1) @enumToInt(SCROLLINFO_MASK.POS) else 0) | (if (o.RANGE == 1) @enumToInt(SCROLLINFO_MASK.RANGE) else 0) | (if (o.TRACKPOS == 1) @enumToInt(SCROLLINFO_MASK.TRACKPOS) else 0));
    }
};
...
pub const KBDLLHOOKSTRUCT_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(KBDLLHOOKSTRUCT_FLAGS, (if (o.EXTENDED == 1) @enumToInt(KBDLLHOOKSTRUCT_FLAGS.EXTENDED) else 0) | (if (o.ALTDOWN == 1) @enumToInt(KBDLLHOOKSTRUCT_FLAGS.ALTDOWN) else 0) | (if (o.UP == 1) @enumToInt(KBDLLHOOKSTRUCT_FLAGS.UP) else 0) | (if (o.INJECTED == 1) @enumToInt(KBDLLHOOKSTRUCT_FLAGS.INJECTED) else 0) | (if (o.LOWER_IL_INJECTED == 1) @enumToInt(KBDLLHOOKSTRUCT_FLAGS.LOWER_IL_INJECTED) else 0));
    }
};
