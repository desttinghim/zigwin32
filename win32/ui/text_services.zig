...
pub const TEXT_STORE_TEXT_CHANGE_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(TEXT_STORE_TEXT_CHANGE_FLAGS, (if (o.NONE == 1) @enumToInt(TEXT_STORE_TEXT_CHANGE_FLAGS.NONE) else 0) | (if (o.CORRECTION == 1) @enumToInt(TEXT_STORE_TEXT_CHANGE_FLAGS.CORRECTION) else 0));
    }
};
...
pub const TEXT_STORE_CHANGE_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(TEXT_STORE_CHANGE_FLAGS, (if (o.NONE == 1) @enumToInt(TEXT_STORE_CHANGE_FLAGS.NONE) else 0) | (if (o.CORRECTION == 1) @enumToInt(TEXT_STORE_CHANGE_FLAGS.CORRECTION) else 0));
    }
};
...
pub const ANCHOR_CHANGE_HISTORY_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(ANCHOR_CHANGE_HISTORY_FLAGS, (if (o.PRECEDING_DEL == 1) @enumToInt(ANCHOR_CHANGE_HISTORY_FLAGS.PRECEDING_DEL) else 0) | (if (o.FOLLOWING_DEL == 1) @enumToInt(ANCHOR_CHANGE_HISTORY_FLAGS.FOLLOWING_DEL) else 0));
    }
};
...
pub const GET_TEXT_AND_PROPERTY_UPDATES_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(GET_TEXT_AND_PROPERTY_UPDATES_FLAGS, (if (o.NONE == 1) @enumToInt(GET_TEXT_AND_PROPERTY_UPDATES_FLAGS.NONE) else 0) | (if (o.INCL_TEXT == 1) @enumToInt(GET_TEXT_AND_PROPERTY_UPDATES_FLAGS.INCL_TEXT) else 0));
    }
};
