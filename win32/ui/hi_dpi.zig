...
pub const DIALOG_CONTROL_DPI_CHANGE_BEHAVIORS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(DIALOG_CONTROL_DPI_CHANGE_BEHAVIORS, (if (o.EFAULT == 1) @enumToInt(DIALOG_CONTROL_DPI_CHANGE_BEHAVIORS.EFAULT) else 0) | (if (o.ISABLE_FONT_UPDATE == 1) @enumToInt(DIALOG_CONTROL_DPI_CHANGE_BEHAVIORS.ISABLE_FONT_UPDATE) else 0) | (if (o.ISABLE_RELAYOUT == 1) @enumToInt(DIALOG_CONTROL_DPI_CHANGE_BEHAVIORS.ISABLE_RELAYOUT) else 0));
    }
};
...
pub const DIALOG_DPI_CHANGE_BEHAVIORS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(DIALOG_DPI_CHANGE_BEHAVIORS, (if (o.EFAULT == 1) @enumToInt(DIALOG_DPI_CHANGE_BEHAVIORS.EFAULT) else 0) | (if (o.ISABLE_ALL == 1) @enumToInt(DIALOG_DPI_CHANGE_BEHAVIORS.ISABLE_ALL) else 0) | (if (o.ISABLE_RESIZE == 1) @enumToInt(DIALOG_DPI_CHANGE_BEHAVIORS.ISABLE_RESIZE) else 0) | (if (o.ISABLE_CONTROL_RELAYOUT == 1) @enumToInt(DIALOG_DPI_CHANGE_BEHAVIORS.ISABLE_CONTROL_RELAYOUT) else 0));
    }
};
