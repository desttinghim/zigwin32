...
pub const KEYBD_EVENT_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(KEYBD_EVENT_FLAGS, (if (o.EXTENDEDKEY == 1) @enumToInt(KEYBD_EVENT_FLAGS.EXTENDEDKEY) else 0) | (if (o.KEYUP == 1) @enumToInt(KEYBD_EVENT_FLAGS.KEYUP) else 0) | (if (o.SCANCODE == 1) @enumToInt(KEYBD_EVENT_FLAGS.SCANCODE) else 0) | (if (o.UNICODE == 1) @enumToInt(KEYBD_EVENT_FLAGS.UNICODE) else 0));
    }
};
