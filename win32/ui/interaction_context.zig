...
pub const INTERACTION_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(INTERACTION_FLAGS, (if (o.NONE == 1) @enumToInt(INTERACTION_FLAGS.NONE) else 0) | (if (o.BEGIN == 1) @enumToInt(INTERACTION_FLAGS.BEGIN) else 0) | (if (o.END == 1) @enumToInt(INTERACTION_FLAGS.END) else 0) | (if (o.CANCEL == 1) @enumToInt(INTERACTION_FLAGS.CANCEL) else 0) | (if (o.INERTIA == 1) @enumToInt(INTERACTION_FLAGS.INERTIA) else 0) | (if (o.MAX == 1) @enumToInt(INTERACTION_FLAGS.MAX) else 0));
    }
};
...
pub const CROSS_SLIDE_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(CROSS_SLIDE_FLAGS, (if (o.NONE == 1) @enumToInt(CROSS_SLIDE_FLAGS.NONE) else 0) | (if (o.SELECT == 1) @enumToInt(CROSS_SLIDE_FLAGS.SELECT) else 0) | (if (o.SPEED_BUMP == 1) @enumToInt(CROSS_SLIDE_FLAGS.SPEED_BUMP) else 0) | (if (o.REARRANGE == 1) @enumToInt(CROSS_SLIDE_FLAGS.REARRANGE) else 0) | (if (o.MAX == 1) @enumToInt(CROSS_SLIDE_FLAGS.MAX) else 0));
    }
};
