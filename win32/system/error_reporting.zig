...
pub const WER_FILE = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(WER_FILE, (if (o.ANONYMOUS_DATA == 1) @enumToInt(WER_FILE.ANONYMOUS_DATA) else 0) | (if (o.DELETE_WHEN_DONE == 1) @enumToInt(WER_FILE.DELETE_WHEN_DONE) else 0));
    }
};
...
pub const WER_FAULT_REPORTING = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(WER_FAULT_REPORTING, (if (o.FLAG_DISABLE_THREAD_SUSPENSION == 1) @enumToInt(WER_FAULT_REPORTING.FLAG_DISABLE_THREAD_SUSPENSION) else 0) | (if (o.FLAG_NOHEAP == 1) @enumToInt(WER_FAULT_REPORTING.FLAG_NOHEAP) else 0) | (if (o.FLAG_QUEUE == 1) @enumToInt(WER_FAULT_REPORTING.FLAG_QUEUE) else 0) | (if (o.FLAG_QUEUE_UPLOAD == 1) @enumToInt(WER_FAULT_REPORTING.FLAG_QUEUE_UPLOAD) else 0) | (if (o.ALWAYS_SHOW_UI == 1) @enumToInt(WER_FAULT_REPORTING.ALWAYS_SHOW_UI) else 0));
    }
};
