...
pub const FILE_MAP = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(FILE_MAP, (if (o.WRITE == 1) @enumToInt(FILE_MAP.WRITE) else 0) | (if (o.READ == 1) @enumToInt(FILE_MAP.READ) else 0) | (if (o.ALL_ACCESS == 1) @enumToInt(FILE_MAP.ALL_ACCESS) else 0) | (if (o.EXECUTE == 1) @enumToInt(FILE_MAP.EXECUTE) else 0) | (if (o.COPY == 1) @enumToInt(FILE_MAP.COPY) else 0) | (if (o.RESERVE == 1) @enumToInt(FILE_MAP.RESERVE) else 0) | (if (o.TARGETS_INVALID == 1) @enumToInt(FILE_MAP.TARGETS_INVALID) else 0) | (if (o.LARGE_PAGES == 1) @enumToInt(FILE_MAP.LARGE_PAGES) else 0));
    }
};
...
pub const HEAP_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(HEAP_FLAGS, (if (o.NONE == 1) @enumToInt(HEAP_FLAGS.NONE) else 0) | (if (o.NO_SERIALIZE == 1) @enumToInt(HEAP_FLAGS.NO_SERIALIZE) else 0) | (if (o.GROWABLE == 1) @enumToInt(HEAP_FLAGS.GROWABLE) else 0) | (if (o.GENERATE_EXCEPTIONS == 1) @enumToInt(HEAP_FLAGS.GENERATE_EXCEPTIONS) else 0) | (if (o.ZERO_MEMORY == 1) @enumToInt(HEAP_FLAGS.ZERO_MEMORY) else 0) | (if (o.REALLOC_IN_PLACE_ONLY == 1) @enumToInt(HEAP_FLAGS.REALLOC_IN_PLACE_ONLY) else 0) | (if (o.TAIL_CHECKING_ENABLED == 1) @enumToInt(HEAP_FLAGS.TAIL_CHECKING_ENABLED) else 0) | (if (o.FREE_CHECKING_ENABLED == 1) @enumToInt(HEAP_FLAGS.FREE_CHECKING_ENABLED) else 0) | (if (o.DISABLE_COALESCE_ON_FREE == 1) @enumToInt(HEAP_FLAGS.DISABLE_COALESCE_ON_FREE) else 0) | (if (o.CREATE_ALIGN_16 == 1) @enumToInt(HEAP_FLAGS.CREATE_ALIGN_16) else 0) | (if (o.CREATE_ENABLE_TRACING == 1) @enumToInt(HEAP_FLAGS.CREATE_ENABLE_TRACING) else 0) | (if (o.CREATE_ENABLE_EXECUTE == 1) @enumToInt(HEAP_FLAGS.CREATE_ENABLE_EXECUTE) else 0) | (if (o.MAXIMUM_TAG == 1) @enumToInt(HEAP_FLAGS.MAXIMUM_TAG) else 0) | (if (o.PSEUDO_TAG_FLAG == 1) @enumToInt(HEAP_FLAGS.PSEUDO_TAG_FLAG) else 0) | (if (o.TAG_SHIFT == 1) @enumToInt(HEAP_FLAGS.TAG_SHIFT) else 0) | (if (o.CREATE_SEGMENT_HEAP == 1) @enumToInt(HEAP_FLAGS.CREATE_SEGMENT_HEAP) else 0) | (if (o.CREATE_HARDENED == 1) @enumToInt(HEAP_FLAGS.CREATE_HARDENED) else 0));
    }
};
...
pub const PAGE_PROTECTION_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(PAGE_PROTECTION_FLAGS, (if (o.PAGE_NOACCESS == 1) @enumToInt(PAGE_PROTECTION_FLAGS.PAGE_NOACCESS) else 0) | (if (o.PAGE_READONLY == 1) @enumToInt(PAGE_PROTECTION_FLAGS.PAGE_READONLY) else 0) | (if (o.PAGE_READWRITE == 1) @enumToInt(PAGE_PROTECTION_FLAGS.PAGE_READWRITE) else 0) | (if (o.PAGE_WRITECOPY == 1) @enumToInt(PAGE_PROTECTION_FLAGS.PAGE_WRITECOPY) else 0) | (if (o.PAGE_EXECUTE == 1) @enumToInt(PAGE_PROTECTION_FLAGS.PAGE_EXECUTE) else 0) | (if (o.PAGE_EXECUTE_READ == 1) @enumToInt(PAGE_PROTECTION_FLAGS.PAGE_EXECUTE_READ) else 0) | (if (o.PAGE_EXECUTE_READWRITE == 1) @enumToInt(PAGE_PROTECTION_FLAGS.PAGE_EXECUTE_READWRITE) else 0) | (if (o.PAGE_EXECUTE_WRITECOPY == 1) @enumToInt(PAGE_PROTECTION_FLAGS.PAGE_EXECUTE_WRITECOPY) else 0) | (if (o.PAGE_GUARD == 1) @enumToInt(PAGE_PROTECTION_FLAGS.PAGE_GUARD) else 0) | (if (o.PAGE_NOCACHE == 1) @enumToInt(PAGE_PROTECTION_FLAGS.PAGE_NOCACHE) else 0) | (if (o.PAGE_WRITECOMBINE == 1) @enumToInt(PAGE_PROTECTION_FLAGS.PAGE_WRITECOMBINE) else 0) | (if (o.PAGE_GRAPHICS_NOACCESS == 1) @enumToInt(PAGE_PROTECTION_FLAGS.PAGE_GRAPHICS_NOACCESS) else 0) | (if (o.PAGE_GRAPHICS_READONLY == 1) @enumToInt(PAGE_PROTECTION_FLAGS.PAGE_GRAPHICS_READONLY) else 0) | (if (o.PAGE_GRAPHICS_READWRITE == 1) @enumToInt(PAGE_PROTECTION_FLAGS.PAGE_GRAPHICS_READWRITE) else 0) | (if (o.PAGE_GRAPHICS_EXECUTE == 1) @enumToInt(PAGE_PROTECTION_FLAGS.PAGE_GRAPHICS_EXECUTE) else 0) | (if (o.PAGE_GRAPHICS_EXECUTE_READ == 1) @enumToInt(PAGE_PROTECTION_FLAGS.PAGE_GRAPHICS_EXECUTE_READ) else 0) | (if (o.PAGE_GRAPHICS_EXECUTE_READWRITE == 1) @enumToInt(PAGE_PROTECTION_FLAGS.PAGE_GRAPHICS_EXECUTE_READWRITE) else 0) | (if (o.PAGE_GRAPHICS_COHERENT == 1) @enumToInt(PAGE_PROTECTION_FLAGS.PAGE_GRAPHICS_COHERENT) else 0) | (if (o.PAGE_GRAPHICS_NOCACHE == 1) @enumToInt(PAGE_PROTECTION_FLAGS.PAGE_GRAPHICS_NOCACHE) else 0) | (if (o.PAGE_ENCLAVE_THREAD_CONTROL == 1) @enumToInt(PAGE_PROTECTION_FLAGS.PAGE_ENCLAVE_THREAD_CONTROL) else 0) | (if (o.PAGE_TARGETS_NO_UPDATE == 1) @enumToInt(PAGE_PROTECTION_FLAGS.PAGE_TARGETS_NO_UPDATE) else 0) | (if (o.PAGE_ENCLAVE_UNVALIDATED == 1) @enumToInt(PAGE_PROTECTION_FLAGS.PAGE_ENCLAVE_UNVALIDATED) else 0) | (if (o.PAGE_ENCLAVE_MASK == 1) @enumToInt(PAGE_PROTECTION_FLAGS.PAGE_ENCLAVE_MASK) else 0) | (if (o.PAGE_ENCLAVE_SS_FIRST == 1) @enumToInt(PAGE_PROTECTION_FLAGS.PAGE_ENCLAVE_SS_FIRST) else 0) | (if (o.PAGE_ENCLAVE_SS_REST == 1) @enumToInt(PAGE_PROTECTION_FLAGS.PAGE_ENCLAVE_SS_REST) else 0) | (if (o.SEC_64K_PAGES == 1) @enumToInt(PAGE_PROTECTION_FLAGS.SEC_64K_PAGES) else 0) | (if (o.SEC_FILE == 1) @enumToInt(PAGE_PROTECTION_FLAGS.SEC_FILE) else 0) | (if (o.SEC_IMAGE == 1) @enumToInt(PAGE_PROTECTION_FLAGS.SEC_IMAGE) else 0) | (if (o.SEC_PROTECTED_IMAGE == 1) @enumToInt(PAGE_PROTECTION_FLAGS.SEC_PROTECTED_IMAGE) else 0) | (if (o.SEC_RESERVE == 1) @enumToInt(PAGE_PROTECTION_FLAGS.SEC_RESERVE) else 0) | (if (o.SEC_COMMIT == 1) @enumToInt(PAGE_PROTECTION_FLAGS.SEC_COMMIT) else 0) | (if (o.SEC_IMAGE_NO_EXECUTE == 1) @enumToInt(PAGE_PROTECTION_FLAGS.SEC_IMAGE_NO_EXECUTE) else 0));
    }
};
...
pub const VIRTUAL_ALLOCATION_TYPE = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(VIRTUAL_ALLOCATION_TYPE, (if (o.COMMIT == 1) @enumToInt(VIRTUAL_ALLOCATION_TYPE.COMMIT) else 0) | (if (o.RESERVE == 1) @enumToInt(VIRTUAL_ALLOCATION_TYPE.RESERVE) else 0) | (if (o.RESET == 1) @enumToInt(VIRTUAL_ALLOCATION_TYPE.RESET) else 0) | (if (o.RESET_UNDO == 1) @enumToInt(VIRTUAL_ALLOCATION_TYPE.RESET_UNDO) else 0) | (if (o.REPLACE_PLACEHOLDER == 1) @enumToInt(VIRTUAL_ALLOCATION_TYPE.REPLACE_PLACEHOLDER) else 0) | (if (o.LARGE_PAGES == 1) @enumToInt(VIRTUAL_ALLOCATION_TYPE.LARGE_PAGES) else 0) | (if (o.RESERVE_PLACEHOLDER == 1) @enumToInt(VIRTUAL_ALLOCATION_TYPE.RESERVE_PLACEHOLDER) else 0) | (if (o.FREE == 1) @enumToInt(VIRTUAL_ALLOCATION_TYPE.FREE) else 0));
    }
};
...
pub const LOCAL_ALLOC_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(LOCAL_ALLOC_FLAGS, (if (o.LHND == 1) @enumToInt(LOCAL_ALLOC_FLAGS.LHND) else 0) | (if (o.LMEM_FIXED == 1) @enumToInt(LOCAL_ALLOC_FLAGS.LMEM_FIXED) else 0) | (if (o.LMEM_MOVEABLE == 1) @enumToInt(LOCAL_ALLOC_FLAGS.LMEM_MOVEABLE) else 0) | (if (o.LMEM_ZEROINIT == 1) @enumToInt(LOCAL_ALLOC_FLAGS.LMEM_ZEROINIT) else 0));
    }
};
...
pub const PAGE_TYPE = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(PAGE_TYPE, (if (o.PRIVATE == 1) @enumToInt(PAGE_TYPE.PRIVATE) else 0) | (if (o.MAPPED == 1) @enumToInt(PAGE_TYPE.MAPPED) else 0) | (if (o.IMAGE == 1) @enumToInt(PAGE_TYPE.IMAGE) else 0));
    }
};
