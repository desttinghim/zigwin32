...
pub const CONSOLE_MODE = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(CONSOLE_MODE, (if (o.ENABLE_PROCESSED_INPUT == 1) @enumToInt(CONSOLE_MODE.ENABLE_PROCESSED_INPUT) else 0) | (if (o.ENABLE_LINE_INPUT == 1) @enumToInt(CONSOLE_MODE.ENABLE_LINE_INPUT) else 0) | (if (o.ENABLE_ECHO_INPUT == 1) @enumToInt(CONSOLE_MODE.ENABLE_ECHO_INPUT) else 0) | (if (o.ENABLE_WINDOW_INPUT == 1) @enumToInt(CONSOLE_MODE.ENABLE_WINDOW_INPUT) else 0) | (if (o.ENABLE_MOUSE_INPUT == 1) @enumToInt(CONSOLE_MODE.ENABLE_MOUSE_INPUT) else 0) | (if (o.ENABLE_INSERT_MODE == 1) @enumToInt(CONSOLE_MODE.ENABLE_INSERT_MODE) else 0) | (if (o.ENABLE_QUICK_EDIT_MODE == 1) @enumToInt(CONSOLE_MODE.ENABLE_QUICK_EDIT_MODE) else 0) | (if (o.ENABLE_EXTENDED_FLAGS == 1) @enumToInt(CONSOLE_MODE.ENABLE_EXTENDED_FLAGS) else 0) | (if (o.ENABLE_AUTO_POSITION == 1) @enumToInt(CONSOLE_MODE.ENABLE_AUTO_POSITION) else 0) | (if (o.ENABLE_VIRTUAL_TERMINAL_INPUT == 1) @enumToInt(CONSOLE_MODE.ENABLE_VIRTUAL_TERMINAL_INPUT) else 0));
    }
};
