...
pub const NAMED_PIPE_MODE = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(NAMED_PIPE_MODE, (if (o.WAIT == 1) @enumToInt(NAMED_PIPE_MODE.WAIT) else 0) | (if (o.NOWAIT == 1) @enumToInt(NAMED_PIPE_MODE.NOWAIT) else 0) | (if (o.READMODE_MESSAGE == 1) @enumToInt(NAMED_PIPE_MODE.READMODE_MESSAGE) else 0) | (if (o.TYPE_MESSAGE == 1) @enumToInt(NAMED_PIPE_MODE.TYPE_MESSAGE) else 0) | (if (o.REJECT_REMOTE_CLIENTS == 1) @enumToInt(NAMED_PIPE_MODE.REJECT_REMOTE_CLIENTS) else 0));
    }
};
