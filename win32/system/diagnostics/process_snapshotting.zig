...
pub const PSS_DUPLICATE_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(PSS_DUPLICATE_FLAGS, (if (o.NONE == 1) @enumToInt(PSS_DUPLICATE_FLAGS.NONE) else 0) | (if (o.CLOSE_SOURCE == 1) @enumToInt(PSS_DUPLICATE_FLAGS.CLOSE_SOURCE) else 0));
    }
};
...
pub const PSS_PROCESS_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(PSS_PROCESS_FLAGS, (if (o.NONE == 1) @enumToInt(PSS_PROCESS_FLAGS.NONE) else 0) | (if (o.PROTECTED == 1) @enumToInt(PSS_PROCESS_FLAGS.PROTECTED) else 0) | (if (o.WOW64 == 1) @enumToInt(PSS_PROCESS_FLAGS.WOW64) else 0) | (if (o.RESERVED_03 == 1) @enumToInt(PSS_PROCESS_FLAGS.RESERVED_03) else 0) | (if (o.RESERVED_04 == 1) @enumToInt(PSS_PROCESS_FLAGS.RESERVED_04) else 0) | (if (o.FROZEN == 1) @enumToInt(PSS_PROCESS_FLAGS.FROZEN) else 0));
    }
};
...
pub const PSS_THREAD_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(PSS_THREAD_FLAGS, (if (o.NONE == 1) @enumToInt(PSS_THREAD_FLAGS.NONE) else 0) | (if (o.TERMINATED == 1) @enumToInt(PSS_THREAD_FLAGS.TERMINATED) else 0));
    }
};
