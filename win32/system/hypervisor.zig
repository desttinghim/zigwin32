...
pub const WHV_X64_CPUID_RESULT2_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(WHV_X64_CPUID_RESULT2_FLAGS, (if (o.SubleafSpecific == 1) @enumToInt(WHV_X64_CPUID_RESULT2_FLAGS.SubleafSpecific) else 0) | (if (o.VpSpecific == 1) @enumToInt(WHV_X64_CPUID_RESULT2_FLAGS.VpSpecific) else 0));
    }
};
...
pub const WHV_TRANSLATE_GVA_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(WHV_TRANSLATE_GVA_FLAGS, (if (o.None == 1) @enumToInt(WHV_TRANSLATE_GVA_FLAGS.None) else 0) | (if (o.ValidateRead == 1) @enumToInt(WHV_TRANSLATE_GVA_FLAGS.ValidateRead) else 0) | (if (o.ValidateWrite == 1) @enumToInt(WHV_TRANSLATE_GVA_FLAGS.ValidateWrite) else 0) | (if (o.ValidateExecute == 1) @enumToInt(WHV_TRANSLATE_GVA_FLAGS.ValidateExecute) else 0) | (if (o.PrivilegeExempt == 1) @enumToInt(WHV_TRANSLATE_GVA_FLAGS.PrivilegeExempt) else 0) | (if (o.SetPageTableBits == 1) @enumToInt(WHV_TRANSLATE_GVA_FLAGS.SetPageTableBits) else 0) | (if (o.EnforceSmap == 1) @enumToInt(WHV_TRANSLATE_GVA_FLAGS.EnforceSmap) else 0) | (if (o.OverrideSmap == 1) @enumToInt(WHV_TRANSLATE_GVA_FLAGS.OverrideSmap) else 0));
    }
};
...
pub const WHV_ALLOCATE_VPCI_RESOURCE_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(WHV_ALLOCATE_VPCI_RESOURCE_FLAGS, (if (o.None == 1) @enumToInt(WHV_ALLOCATE_VPCI_RESOURCE_FLAGS.None) else 0) | (if (o.AllowDirectP2P == 1) @enumToInt(WHV_ALLOCATE_VPCI_RESOURCE_FLAGS.AllowDirectP2P) else 0));
    }
};
...
pub const WHV_CREATE_VPCI_DEVICE_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(WHV_CREATE_VPCI_DEVICE_FLAGS, (if (o.None == 1) @enumToInt(WHV_CREATE_VPCI_DEVICE_FLAGS.None) else 0) | (if (o.PhysicallyBacked == 1) @enumToInt(WHV_CREATE_VPCI_DEVICE_FLAGS.PhysicallyBacked) else 0) | (if (o.UseLogicalInterrupts == 1) @enumToInt(WHV_CREATE_VPCI_DEVICE_FLAGS.UseLogicalInterrupts) else 0));
    }
};
...
pub const WHV_VPCI_MMIO_RANGE_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(WHV_VPCI_MMIO_RANGE_FLAGS, (if (o.ReadAccess == 1) @enumToInt(WHV_VPCI_MMIO_RANGE_FLAGS.ReadAccess) else 0) | (if (o.WriteAccess == 1) @enumToInt(WHV_VPCI_MMIO_RANGE_FLAGS.WriteAccess) else 0));
    }
};
...
pub const WHV_VPCI_INTERRUPT_TARGET_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(WHV_VPCI_INTERRUPT_TARGET_FLAGS, (if (o.None == 1) @enumToInt(WHV_VPCI_INTERRUPT_TARGET_FLAGS.None) else 0) | (if (o.Multicast == 1) @enumToInt(WHV_VPCI_INTERRUPT_TARGET_FLAGS.Multicast) else 0));
    }
};
...
pub const HDV_MMIO_MAPPING_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(HDV_MMIO_MAPPING_FLAGS, (if (o.None == 1) @enumToInt(HDV_MMIO_MAPPING_FLAGS.None) else 0) | (if (o.Writeable == 1) @enumToInt(HDV_MMIO_MAPPING_FLAGS.Writeable) else 0) | (if (o.Executable == 1) @enumToInt(HDV_MMIO_MAPPING_FLAGS.Executable) else 0));
    }
};
