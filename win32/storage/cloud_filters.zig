...
pub const CF_PLACEHOLDER_CREATE_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(CF_PLACEHOLDER_CREATE_FLAGS, (if (o.NONE == 1) @enumToInt(CF_PLACEHOLDER_CREATE_FLAGS.NONE) else 0) | (if (o.DISABLE_ON_DEMAND_POPULATION == 1) @enumToInt(CF_PLACEHOLDER_CREATE_FLAGS.DISABLE_ON_DEMAND_POPULATION) else 0) | (if (o.MARK_IN_SYNC == 1) @enumToInt(CF_PLACEHOLDER_CREATE_FLAGS.MARK_IN_SYNC) else 0) | (if (o.SUPERSEDE == 1) @enumToInt(CF_PLACEHOLDER_CREATE_FLAGS.SUPERSEDE) else 0) | (if (o.ALWAYS_FULL == 1) @enumToInt(CF_PLACEHOLDER_CREATE_FLAGS.ALWAYS_FULL) else 0));
    }
};
...
pub const CF_REGISTER_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(CF_REGISTER_FLAGS, (if (o.NONE == 1) @enumToInt(CF_REGISTER_FLAGS.NONE) else 0) | (if (o.UPDATE == 1) @enumToInt(CF_REGISTER_FLAGS.UPDATE) else 0) | (if (o.DISABLE_ON_DEMAND_POPULATION_ON_ROOT == 1) @enumToInt(CF_REGISTER_FLAGS.DISABLE_ON_DEMAND_POPULATION_ON_ROOT) else 0) | (if (o.MARK_IN_SYNC_ON_ROOT == 1) @enumToInt(CF_REGISTER_FLAGS.MARK_IN_SYNC_ON_ROOT) else 0));
    }
};
...
pub const CF_HYDRATION_POLICY_MODIFIER = enum(u16) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(CF_HYDRATION_POLICY_MODIFIER, (if (o.NONE == 1) @enumToInt(CF_HYDRATION_POLICY_MODIFIER.NONE) else 0) | (if (o.VALIDATION_REQUIRED == 1) @enumToInt(CF_HYDRATION_POLICY_MODIFIER.VALIDATION_REQUIRED) else 0) | (if (o.STREAMING_ALLOWED == 1) @enumToInt(CF_HYDRATION_POLICY_MODIFIER.STREAMING_ALLOWED) else 0) | (if (o.AUTO_DEHYDRATION_ALLOWED == 1) @enumToInt(CF_HYDRATION_POLICY_MODIFIER.AUTO_DEHYDRATION_ALLOWED) else 0) | (if (o.ALLOW_FULL_RESTART_HYDRATION == 1) @enumToInt(CF_HYDRATION_POLICY_MODIFIER.ALLOW_FULL_RESTART_HYDRATION) else 0));
    }
};
...
pub const CF_POPULATION_POLICY_MODIFIER = enum(u16) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(CF_POPULATION_POLICY_MODIFIER, (if (o.E == 1) @enumToInt(CF_POPULATION_POLICY_MODIFIER.E) else 0));
    }
};
...
pub const CF_HARDLINK_POLICY = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(CF_HARDLINK_POLICY, (if (o.NONE == 1) @enumToInt(CF_HARDLINK_POLICY.NONE) else 0) | (if (o.ALLOWED == 1) @enumToInt(CF_HARDLINK_POLICY.ALLOWED) else 0));
    }
};
...
pub const CF_CALLBACK_CANCEL_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(CF_CALLBACK_CANCEL_FLAGS, (if (o.NONE == 1) @enumToInt(CF_CALLBACK_CANCEL_FLAGS.NONE) else 0) | (if (o.IO_TIMEOUT == 1) @enumToInt(CF_CALLBACK_CANCEL_FLAGS.IO_TIMEOUT) else 0) | (if (o.IO_ABORTED == 1) @enumToInt(CF_CALLBACK_CANCEL_FLAGS.IO_ABORTED) else 0));
    }
};
...
pub const CF_CALLBACK_FETCH_DATA_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(CF_CALLBACK_FETCH_DATA_FLAGS, (if (o.NONE == 1) @enumToInt(CF_CALLBACK_FETCH_DATA_FLAGS.NONE) else 0) | (if (o.RECOVERY == 1) @enumToInt(CF_CALLBACK_FETCH_DATA_FLAGS.RECOVERY) else 0) | (if (o.EXPLICIT_HYDRATION == 1) @enumToInt(CF_CALLBACK_FETCH_DATA_FLAGS.EXPLICIT_HYDRATION) else 0));
    }
};
...
pub const CF_CALLBACK_VALIDATE_DATA_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(CF_CALLBACK_VALIDATE_DATA_FLAGS, (if (o.NONE == 1) @enumToInt(CF_CALLBACK_VALIDATE_DATA_FLAGS.NONE) else 0) | (if (o.EXPLICIT_HYDRATION == 1) @enumToInt(CF_CALLBACK_VALIDATE_DATA_FLAGS.EXPLICIT_HYDRATION) else 0));
    }
};
...
pub const CF_CALLBACK_FETCH_PLACEHOLDERS_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(CF_CALLBACK_FETCH_PLACEHOLDERS_FLAGS, (if (o.E == 1) @enumToInt(CF_CALLBACK_FETCH_PLACEHOLDERS_FLAGS.E) else 0));
    }
};
...
pub const CF_CALLBACK_CLOSE_COMPLETION_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(CF_CALLBACK_CLOSE_COMPLETION_FLAGS, (if (o.NONE == 1) @enumToInt(CF_CALLBACK_CLOSE_COMPLETION_FLAGS.NONE) else 0) | (if (o.DELETED == 1) @enumToInt(CF_CALLBACK_CLOSE_COMPLETION_FLAGS.DELETED) else 0));
    }
};
...
pub const CF_CALLBACK_DEHYDRATE_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(CF_CALLBACK_DEHYDRATE_FLAGS, (if (o.NONE == 1) @enumToInt(CF_CALLBACK_DEHYDRATE_FLAGS.NONE) else 0) | (if (o.BACKGROUND == 1) @enumToInt(CF_CALLBACK_DEHYDRATE_FLAGS.BACKGROUND) else 0));
    }
};
...
pub const CF_CALLBACK_DEHYDRATE_COMPLETION_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(CF_CALLBACK_DEHYDRATE_COMPLETION_FLAGS, (if (o.NONE == 1) @enumToInt(CF_CALLBACK_DEHYDRATE_COMPLETION_FLAGS.NONE) else 0) | (if (o.BACKGROUND == 1) @enumToInt(CF_CALLBACK_DEHYDRATE_COMPLETION_FLAGS.BACKGROUND) else 0) | (if (o.DEHYDRATED == 1) @enumToInt(CF_CALLBACK_DEHYDRATE_COMPLETION_FLAGS.DEHYDRATED) else 0));
    }
};
...
pub const CF_CALLBACK_DELETE_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(CF_CALLBACK_DELETE_FLAGS, (if (o.NONE == 1) @enumToInt(CF_CALLBACK_DELETE_FLAGS.NONE) else 0) | (if (o.IS_DIRECTORY == 1) @enumToInt(CF_CALLBACK_DELETE_FLAGS.IS_DIRECTORY) else 0) | (if (o.IS_UNDELETE == 1) @enumToInt(CF_CALLBACK_DELETE_FLAGS.IS_UNDELETE) else 0));
    }
};
...
pub const CF_CALLBACK_DELETE_COMPLETION_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(CF_CALLBACK_DELETE_COMPLETION_FLAGS, (if (o.E == 1) @enumToInt(CF_CALLBACK_DELETE_COMPLETION_FLAGS.E) else 0));
    }
};
...
pub const CF_CALLBACK_RENAME_COMPLETION_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(CF_CALLBACK_RENAME_COMPLETION_FLAGS, (if (o.E == 1) @enumToInt(CF_CALLBACK_RENAME_COMPLETION_FLAGS.E) else 0));
    }
};
...
pub const CF_CONNECT_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(CF_CONNECT_FLAGS, (if (o.NONE == 1) @enumToInt(CF_CONNECT_FLAGS.NONE) else 0) | (if (o.REQUIRE_PROCESS_INFO == 1) @enumToInt(CF_CONNECT_FLAGS.REQUIRE_PROCESS_INFO) else 0) | (if (o.REQUIRE_FULL_FILE_PATH == 1) @enumToInt(CF_CONNECT_FLAGS.REQUIRE_FULL_FILE_PATH) else 0) | (if (o.BLOCK_SELF_IMPLICIT_HYDRATION == 1) @enumToInt(CF_CONNECT_FLAGS.BLOCK_SELF_IMPLICIT_HYDRATION) else 0));
    }
};
...
pub const CF_OPERATION_TRANSFER_DATA_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(CF_OPERATION_TRANSFER_DATA_FLAGS, (if (o.E == 1) @enumToInt(CF_OPERATION_TRANSFER_DATA_FLAGS.E) else 0));
    }
};
...
pub const CF_OPERATION_RETRIEVE_DATA_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(CF_OPERATION_RETRIEVE_DATA_FLAGS, (if (o.E == 1) @enumToInt(CF_OPERATION_RETRIEVE_DATA_FLAGS.E) else 0));
    }
};
...
pub const CF_OPERATION_ACK_DATA_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(CF_OPERATION_ACK_DATA_FLAGS, (if (o.E == 1) @enumToInt(CF_OPERATION_ACK_DATA_FLAGS.E) else 0));
    }
};
...
pub const CF_OPERATION_RESTART_HYDRATION_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(CF_OPERATION_RESTART_HYDRATION_FLAGS, (if (o.NONE == 1) @enumToInt(CF_OPERATION_RESTART_HYDRATION_FLAGS.NONE) else 0) | (if (o.MARK_IN_SYNC == 1) @enumToInt(CF_OPERATION_RESTART_HYDRATION_FLAGS.MARK_IN_SYNC) else 0));
    }
};
...
pub const CF_OPERATION_TRANSFER_PLACEHOLDERS_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(CF_OPERATION_TRANSFER_PLACEHOLDERS_FLAGS, (if (o.NONE == 1) @enumToInt(CF_OPERATION_TRANSFER_PLACEHOLDERS_FLAGS.NONE) else 0) | (if (o.STOP_ON_ERROR == 1) @enumToInt(CF_OPERATION_TRANSFER_PLACEHOLDERS_FLAGS.STOP_ON_ERROR) else 0) | (if (o.DISABLE_ON_DEMAND_POPULATION == 1) @enumToInt(CF_OPERATION_TRANSFER_PLACEHOLDERS_FLAGS.DISABLE_ON_DEMAND_POPULATION) else 0));
    }
};
...
pub const CF_OPERATION_ACK_DEHYDRATE_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(CF_OPERATION_ACK_DEHYDRATE_FLAGS, (if (o.E == 1) @enumToInt(CF_OPERATION_ACK_DEHYDRATE_FLAGS.E) else 0));
    }
};
...
pub const CF_OPERATION_ACK_RENAME_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(CF_OPERATION_ACK_RENAME_FLAGS, (if (o.E == 1) @enumToInt(CF_OPERATION_ACK_RENAME_FLAGS.E) else 0));
    }
};
...
pub const CF_OPERATION_ACK_DELETE_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(CF_OPERATION_ACK_DELETE_FLAGS, (if (o.E == 1) @enumToInt(CF_OPERATION_ACK_DELETE_FLAGS.E) else 0));
    }
};
...
pub const CF_CREATE_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(CF_CREATE_FLAGS, (if (o.NONE == 1) @enumToInt(CF_CREATE_FLAGS.NONE) else 0) | (if (o.STOP_ON_ERROR == 1) @enumToInt(CF_CREATE_FLAGS.STOP_ON_ERROR) else 0));
    }
};
...
pub const CF_OPEN_FILE_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(CF_OPEN_FILE_FLAGS, (if (o.NONE == 1) @enumToInt(CF_OPEN_FILE_FLAGS.NONE) else 0) | (if (o.EXCLUSIVE == 1) @enumToInt(CF_OPEN_FILE_FLAGS.EXCLUSIVE) else 0) | (if (o.WRITE_ACCESS == 1) @enumToInt(CF_OPEN_FILE_FLAGS.WRITE_ACCESS) else 0) | (if (o.DELETE_ACCESS == 1) @enumToInt(CF_OPEN_FILE_FLAGS.DELETE_ACCESS) else 0) | (if (o.FOREGROUND == 1) @enumToInt(CF_OPEN_FILE_FLAGS.FOREGROUND) else 0));
    }
};
...
pub const CF_CONVERT_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(CF_CONVERT_FLAGS, (if (o.NONE == 1) @enumToInt(CF_CONVERT_FLAGS.NONE) else 0) | (if (o.MARK_IN_SYNC == 1) @enumToInt(CF_CONVERT_FLAGS.MARK_IN_SYNC) else 0) | (if (o.DEHYDRATE == 1) @enumToInt(CF_CONVERT_FLAGS.DEHYDRATE) else 0) | (if (o.ENABLE_ON_DEMAND_POPULATION == 1) @enumToInt(CF_CONVERT_FLAGS.ENABLE_ON_DEMAND_POPULATION) else 0) | (if (o.ALWAYS_FULL == 1) @enumToInt(CF_CONVERT_FLAGS.ALWAYS_FULL) else 0) | (if (o.FORCE_CONVERT_TO_CLOUD_FILE == 1) @enumToInt(CF_CONVERT_FLAGS.FORCE_CONVERT_TO_CLOUD_FILE) else 0));
    }
};
...
pub const CF_UPDATE_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(CF_UPDATE_FLAGS, (if (o.NONE == 1) @enumToInt(CF_UPDATE_FLAGS.NONE) else 0) | (if (o.VERIFY_IN_SYNC == 1) @enumToInt(CF_UPDATE_FLAGS.VERIFY_IN_SYNC) else 0) | (if (o.MARK_IN_SYNC == 1) @enumToInt(CF_UPDATE_FLAGS.MARK_IN_SYNC) else 0) | (if (o.DEHYDRATE == 1) @enumToInt(CF_UPDATE_FLAGS.DEHYDRATE) else 0) | (if (o.ENABLE_ON_DEMAND_POPULATION == 1) @enumToInt(CF_UPDATE_FLAGS.ENABLE_ON_DEMAND_POPULATION) else 0) | (if (o.DISABLE_ON_DEMAND_POPULATION == 1) @enumToInt(CF_UPDATE_FLAGS.DISABLE_ON_DEMAND_POPULATION) else 0) | (if (o.REMOVE_FILE_IDENTITY == 1) @enumToInt(CF_UPDATE_FLAGS.REMOVE_FILE_IDENTITY) else 0) | (if (o.CLEAR_IN_SYNC == 1) @enumToInt(CF_UPDATE_FLAGS.CLEAR_IN_SYNC) else 0) | (if (o.REMOVE_PROPERTY == 1) @enumToInt(CF_UPDATE_FLAGS.REMOVE_PROPERTY) else 0) | (if (o.PASSTHROUGH_FS_METADATA == 1) @enumToInt(CF_UPDATE_FLAGS.PASSTHROUGH_FS_METADATA) else 0) | (if (o.ALWAYS_FULL == 1) @enumToInt(CF_UPDATE_FLAGS.ALWAYS_FULL) else 0) | (if (o.ALLOW_PARTIAL == 1) @enumToInt(CF_UPDATE_FLAGS.ALLOW_PARTIAL) else 0));
    }
};
...
pub const CF_REVERT_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(CF_REVERT_FLAGS, (if (o.E == 1) @enumToInt(CF_REVERT_FLAGS.E) else 0));
    }
};
...
pub const CF_HYDRATE_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(CF_HYDRATE_FLAGS, (if (o.E == 1) @enumToInt(CF_HYDRATE_FLAGS.E) else 0));
    }
};
...
pub const CF_DEHYDRATE_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(CF_DEHYDRATE_FLAGS, (if (o.NONE == 1) @enumToInt(CF_DEHYDRATE_FLAGS.NONE) else 0) | (if (o.BACKGROUND == 1) @enumToInt(CF_DEHYDRATE_FLAGS.BACKGROUND) else 0));
    }
};
...
pub const CF_SET_PIN_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(CF_SET_PIN_FLAGS, (if (o.NONE == 1) @enumToInt(CF_SET_PIN_FLAGS.NONE) else 0) | (if (o.RECURSE == 1) @enumToInt(CF_SET_PIN_FLAGS.RECURSE) else 0) | (if (o.RECURSE_ONLY == 1) @enumToInt(CF_SET_PIN_FLAGS.RECURSE_ONLY) else 0) | (if (o.RECURSE_STOP_ON_ERROR == 1) @enumToInt(CF_SET_PIN_FLAGS.RECURSE_STOP_ON_ERROR) else 0));
    }
};
...
pub const CF_SET_IN_SYNC_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(CF_SET_IN_SYNC_FLAGS, (if (o.E == 1) @enumToInt(CF_SET_IN_SYNC_FLAGS.E) else 0));
    }
};
...
pub const CF_PLACEHOLDER_STATE = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(CF_PLACEHOLDER_STATE, (if (o.NO_STATES == 1) @enumToInt(CF_PLACEHOLDER_STATE.NO_STATES) else 0) | (if (o.PLACEHOLDER == 1) @enumToInt(CF_PLACEHOLDER_STATE.PLACEHOLDER) else 0) | (if (o.SYNC_ROOT == 1) @enumToInt(CF_PLACEHOLDER_STATE.SYNC_ROOT) else 0) | (if (o.ESSENTIAL_PROP_PRESENT == 1) @enumToInt(CF_PLACEHOLDER_STATE.ESSENTIAL_PROP_PRESENT) else 0) | (if (o.IN_SYNC == 1) @enumToInt(CF_PLACEHOLDER_STATE.IN_SYNC) else 0) | (if (o.PARTIAL == 1) @enumToInt(CF_PLACEHOLDER_STATE.PARTIAL) else 0) | (if (o.PARTIALLY_ON_DISK == 1) @enumToInt(CF_PLACEHOLDER_STATE.PARTIALLY_ON_DISK) else 0) | (if (o.INVALID == 1) @enumToInt(CF_PLACEHOLDER_STATE.INVALID) else 0));
    }
};
