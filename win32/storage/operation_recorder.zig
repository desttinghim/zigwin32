...
pub const OPERATION_START_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(OPERATION_START_FLAGS, (if (o.D == 1) @enumToInt(OPERATION_START_FLAGS.D) else 0));
    }
};
...
pub const OPERATION_END_PARAMETERS_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(OPERATION_END_PARAMETERS_FLAGS, (if (o.D == 1) @enumToInt(OPERATION_END_PARAMETERS_FLAGS.D) else 0));
    }
};
