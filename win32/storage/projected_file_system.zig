...
pub const PRJ_STARTVIRTUALIZING_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(PRJ_STARTVIRTUALIZING_FLAGS, (if (o.NONE == 1) @enumToInt(PRJ_STARTVIRTUALIZING_FLAGS.NONE) else 0) | (if (o.USE_NEGATIVE_PATH_CACHE == 1) @enumToInt(PRJ_STARTVIRTUALIZING_FLAGS.USE_NEGATIVE_PATH_CACHE) else 0));
    }
};
...
pub const PRJ_FILE_STATE = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(PRJ_FILE_STATE, (if (o.PLACEHOLDER == 1) @enumToInt(PRJ_FILE_STATE.PLACEHOLDER) else 0) | (if (o.HYDRATED_PLACEHOLDER == 1) @enumToInt(PRJ_FILE_STATE.HYDRATED_PLACEHOLDER) else 0) | (if (o.DIRTY_PLACEHOLDER == 1) @enumToInt(PRJ_FILE_STATE.DIRTY_PLACEHOLDER) else 0) | (if (o.FULL == 1) @enumToInt(PRJ_FILE_STATE.FULL) else 0) | (if (o.TOMBSTONE == 1) @enumToInt(PRJ_FILE_STATE.TOMBSTONE) else 0));
    }
};
