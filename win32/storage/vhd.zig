...
pub const OPEN_VIRTUAL_DISK_FLAG = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(OPEN_VIRTUAL_DISK_FLAG, (if (o.NONE == 1) @enumToInt(OPEN_VIRTUAL_DISK_FLAG.NONE) else 0) | (if (o.NO_PARENTS == 1) @enumToInt(OPEN_VIRTUAL_DISK_FLAG.NO_PARENTS) else 0) | (if (o.BLANK_FILE == 1) @enumToInt(OPEN_VIRTUAL_DISK_FLAG.BLANK_FILE) else 0) | (if (o.BOOT_DRIVE == 1) @enumToInt(OPEN_VIRTUAL_DISK_FLAG.BOOT_DRIVE) else 0) | (if (o.CACHED_IO == 1) @enumToInt(OPEN_VIRTUAL_DISK_FLAG.CACHED_IO) else 0) | (if (o.CUSTOM_DIFF_CHAIN == 1) @enumToInt(OPEN_VIRTUAL_DISK_FLAG.CUSTOM_DIFF_CHAIN) else 0) | (if (o.PARENT_CACHED_IO == 1) @enumToInt(OPEN_VIRTUAL_DISK_FLAG.PARENT_CACHED_IO) else 0) | (if (o.VHDSET_FILE_ONLY == 1) @enumToInt(OPEN_VIRTUAL_DISK_FLAG.VHDSET_FILE_ONLY) else 0) | (if (o.IGNORE_RELATIVE_PARENT_LOCATOR == 1) @enumToInt(OPEN_VIRTUAL_DISK_FLAG.IGNORE_RELATIVE_PARENT_LOCATOR) else 0) | (if (o.NO_WRITE_HARDENING == 1) @enumToInt(OPEN_VIRTUAL_DISK_FLAG.NO_WRITE_HARDENING) else 0) | (if (o.SUPPORT_COMPRESSED_VOLUMES == 1) @enumToInt(OPEN_VIRTUAL_DISK_FLAG.SUPPORT_COMPRESSED_VOLUMES) else 0) | (if (o.SUPPORT_SPARSE_FILES_ANY_FS == 1) @enumToInt(OPEN_VIRTUAL_DISK_FLAG.SUPPORT_SPARSE_FILES_ANY_FS) else 0) | (if (o.SUPPORT_ENCRYPTED_FILES == 1) @enumToInt(OPEN_VIRTUAL_DISK_FLAG.SUPPORT_ENCRYPTED_FILES) else 0));
    }
};
...
pub const DETACH_VIRTUAL_DISK_FLAG = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(DETACH_VIRTUAL_DISK_FLAG, (if (o.E == 1) @enumToInt(DETACH_VIRTUAL_DISK_FLAG.E) else 0));
    }
};
...
pub const GET_STORAGE_DEPENDENCY_FLAG = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(GET_STORAGE_DEPENDENCY_FLAG, (if (o.NONE == 1) @enumToInt(GET_STORAGE_DEPENDENCY_FLAG.NONE) else 0) | (if (o.HOST_VOLUMES == 1) @enumToInt(GET_STORAGE_DEPENDENCY_FLAG.HOST_VOLUMES) else 0) | (if (o.DISK_HANDLE == 1) @enumToInt(GET_STORAGE_DEPENDENCY_FLAG.DISK_HANDLE) else 0));
    }
};
...
pub const COMPACT_VIRTUAL_DISK_FLAG = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(COMPACT_VIRTUAL_DISK_FLAG, (if (o.NE == 1) @enumToInt(COMPACT_VIRTUAL_DISK_FLAG.NE) else 0) | (if (o._ZERO_SCAN == 1) @enumToInt(COMPACT_VIRTUAL_DISK_FLAG._ZERO_SCAN) else 0) | (if (o._BLOCK_MOVES == 1) @enumToInt(COMPACT_VIRTUAL_DISK_FLAG._BLOCK_MOVES) else 0));
    }
};
...
pub const MERGE_VIRTUAL_DISK_FLAG = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(MERGE_VIRTUAL_DISK_FLAG, (if (o.E == 1) @enumToInt(MERGE_VIRTUAL_DISK_FLAG.E) else 0));
    }
};
...
pub const EXPAND_VIRTUAL_DISK_FLAG = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(EXPAND_VIRTUAL_DISK_FLAG, (if (o.NE == 1) @enumToInt(EXPAND_VIRTUAL_DISK_FLAG.NE) else 0) | (if (o.TIFY_CHANGE == 1) @enumToInt(EXPAND_VIRTUAL_DISK_FLAG.TIFY_CHANGE) else 0));
    }
};
...
pub const MIRROR_VIRTUAL_DISK_FLAG = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(MIRROR_VIRTUAL_DISK_FLAG, (if (o.NONE == 1) @enumToInt(MIRROR_VIRTUAL_DISK_FLAG.NONE) else 0) | (if (o.EXISTING_FILE == 1) @enumToInt(MIRROR_VIRTUAL_DISK_FLAG.EXISTING_FILE) else 0) | (if (o.SKIP_MIRROR_ACTIVATION == 1) @enumToInt(MIRROR_VIRTUAL_DISK_FLAG.SKIP_MIRROR_ACTIVATION) else 0) | (if (o.ENABLE_SMB_COMPRESSION == 1) @enumToInt(MIRROR_VIRTUAL_DISK_FLAG.ENABLE_SMB_COMPRESSION) else 0) | (if (o.IS_LIVE_MIGRATION == 1) @enumToInt(MIRROR_VIRTUAL_DISK_FLAG.IS_LIVE_MIGRATION) else 0));
    }
};
...
pub const QUERY_CHANGES_VIRTUAL_DISK_FLAG = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(QUERY_CHANGES_VIRTUAL_DISK_FLAG, (if (o.E == 1) @enumToInt(QUERY_CHANGES_VIRTUAL_DISK_FLAG.E) else 0));
    }
};
...
pub const TAKE_SNAPSHOT_VHDSET_FLAG = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(TAKE_SNAPSHOT_VHDSET_FLAG, (if (o.NONE == 1) @enumToInt(TAKE_SNAPSHOT_VHDSET_FLAG.NONE) else 0) | (if (o.WRITEABLE == 1) @enumToInt(TAKE_SNAPSHOT_VHDSET_FLAG.WRITEABLE) else 0));
    }
};
...
pub const DELETE_SNAPSHOT_VHDSET_FLAG = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(DELETE_SNAPSHOT_VHDSET_FLAG, (if (o.NONE == 1) @enumToInt(DELETE_SNAPSHOT_VHDSET_FLAG.NONE) else 0) | (if (o.PERSIST_RCT == 1) @enumToInt(DELETE_SNAPSHOT_VHDSET_FLAG.PERSIST_RCT) else 0));
    }
};
...
pub const MODIFY_VHDSET_FLAG = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(MODIFY_VHDSET_FLAG, (if (o.NONE == 1) @enumToInt(MODIFY_VHDSET_FLAG.NONE) else 0) | (if (o.WRITEABLE_SNAPSHOT == 1) @enumToInt(MODIFY_VHDSET_FLAG.WRITEABLE_SNAPSHOT) else 0));
    }
};
...
pub const APPLY_SNAPSHOT_VHDSET_FLAG = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(APPLY_SNAPSHOT_VHDSET_FLAG, (if (o.NONE == 1) @enumToInt(APPLY_SNAPSHOT_VHDSET_FLAG.NONE) else 0) | (if (o.WRITEABLE == 1) @enumToInt(APPLY_SNAPSHOT_VHDSET_FLAG.WRITEABLE) else 0));
    }
};
...
pub const RAW_SCSI_VIRTUAL_DISK_FLAG = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(RAW_SCSI_VIRTUAL_DISK_FLAG, (if (o.E == 1) @enumToInt(RAW_SCSI_VIRTUAL_DISK_FLAG.E) else 0));
    }
};
...
pub const FORK_VIRTUAL_DISK_FLAG = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(FORK_VIRTUAL_DISK_FLAG, (if (o.NONE == 1) @enumToInt(FORK_VIRTUAL_DISK_FLAG.NONE) else 0) | (if (o.EXISTING_FILE == 1) @enumToInt(FORK_VIRTUAL_DISK_FLAG.EXISTING_FILE) else 0));
    }
};
