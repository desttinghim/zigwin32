...
pub const FIND_FIRST_EX_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(FIND_FIRST_EX_FLAGS, (if (o.CASE_SENSITIVE == 1) @enumToInt(FIND_FIRST_EX_FLAGS.CASE_SENSITIVE) else 0) | (if (o.LARGE_FETCH == 1) @enumToInt(FIND_FIRST_EX_FLAGS.LARGE_FETCH) else 0) | (if (o.ON_DISK_ENTRIES_ONLY == 1) @enumToInt(FIND_FIRST_EX_FLAGS.ON_DISK_ENTRIES_ONLY) else 0));
    }
};
...
pub const GET_FILE_VERSION_INFO_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(GET_FILE_VERSION_INFO_FLAGS, (if (o.LOCALISED == 1) @enumToInt(GET_FILE_VERSION_INFO_FLAGS.LOCALISED) else 0) | (if (o.NEUTRAL == 1) @enumToInt(GET_FILE_VERSION_INFO_FLAGS.NEUTRAL) else 0) | (if (o.PREFETCHED == 1) @enumToInt(GET_FILE_VERSION_INFO_FLAGS.PREFETCHED) else 0));
    }
};
...
pub const VER_FIND_FILE_STATUS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(VER_FIND_FILE_STATUS, (if (o.CURNEDEST == 1) @enumToInt(VER_FIND_FILE_STATUS.CURNEDEST) else 0) | (if (o.FILEINUSE == 1) @enumToInt(VER_FIND_FILE_STATUS.FILEINUSE) else 0) | (if (o.BUFFTOOSMALL == 1) @enumToInt(VER_FIND_FILE_STATUS.BUFFTOOSMALL) else 0));
    }
};
...
pub const VS_FIXEDFILEINFO_FILE_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(VS_FIXEDFILEINFO_FILE_FLAGS, (if (o.DEBUG == 1) @enumToInt(VS_FIXEDFILEINFO_FILE_FLAGS.DEBUG) else 0) | (if (o.PRERELEASE == 1) @enumToInt(VS_FIXEDFILEINFO_FILE_FLAGS.PRERELEASE) else 0) | (if (o.PATCHED == 1) @enumToInt(VS_FIXEDFILEINFO_FILE_FLAGS.PATCHED) else 0) | (if (o.PRIVATEBUILD == 1) @enumToInt(VS_FIXEDFILEINFO_FILE_FLAGS.PRIVATEBUILD) else 0) | (if (o.INFOINFERRED == 1) @enumToInt(VS_FIXEDFILEINFO_FILE_FLAGS.INFOINFERRED) else 0) | (if (o.SPECIALBUILD == 1) @enumToInt(VS_FIXEDFILEINFO_FILE_FLAGS.SPECIALBUILD) else 0));
    }
};
...
pub const FILE_SHARE_MODE = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(FILE_SHARE_MODE, (if (o.NONE == 1) @enumToInt(FILE_SHARE_MODE.NONE) else 0) | (if (o.DELETE == 1) @enumToInt(FILE_SHARE_MODE.DELETE) else 0) | (if (o.READ == 1) @enumToInt(FILE_SHARE_MODE.READ) else 0) | (if (o.WRITE == 1) @enumToInt(FILE_SHARE_MODE.WRITE) else 0));
    }
};
...
pub const SHARE_TYPE = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(SHARE_TYPE, (if (o.DISKTREE == 1) @enumToInt(SHARE_TYPE.DISKTREE) else 0) | (if (o.PRINTQ == 1) @enumToInt(SHARE_TYPE.PRINTQ) else 0) | (if (o.DEVICE == 1) @enumToInt(SHARE_TYPE.DEVICE) else 0) | (if (o.IPC == 1) @enumToInt(SHARE_TYPE.IPC) else 0) | (if (o.SPECIAL == 1) @enumToInt(SHARE_TYPE.SPECIAL) else 0) | (if (o.TEMPORARY == 1) @enumToInt(SHARE_TYPE.TEMPORARY) else 0) | (if (o.MASK == 1) @enumToInt(SHARE_TYPE.MASK) else 0));
    }
};
...
pub const CLFS_FLAG = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(CLFS_FLAG, (if (o.FORCE_APPEND == 1) @enumToInt(CLFS_FLAG.FORCE_APPEND) else 0) | (if (o.FORCE_FLUSH == 1) @enumToInt(CLFS_FLAG.FORCE_FLUSH) else 0) | (if (o.NO_FLAGS == 1) @enumToInt(CLFS_FLAG.NO_FLAGS) else 0) | (if (o.USE_RESERVATION == 1) @enumToInt(CLFS_FLAG.USE_RESERVATION) else 0));
    }
};
...
pub const MOVE_FILE_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(MOVE_FILE_FLAGS, (if (o.COPY_ALLOWED == 1) @enumToInt(MOVE_FILE_FLAGS.COPY_ALLOWED) else 0) | (if (o.CREATE_HARDLINK == 1) @enumToInt(MOVE_FILE_FLAGS.CREATE_HARDLINK) else 0) | (if (o.DELAY_UNTIL_REBOOT == 1) @enumToInt(MOVE_FILE_FLAGS.DELAY_UNTIL_REBOOT) else 0) | (if (o.REPLACE_EXISTING == 1) @enumToInt(MOVE_FILE_FLAGS.REPLACE_EXISTING) else 0) | (if (o.WRITE_THROUGH == 1) @enumToInt(MOVE_FILE_FLAGS.WRITE_THROUGH) else 0) | (if (o.FAIL_IF_NOT_TRACKABLE == 1) @enumToInt(MOVE_FILE_FLAGS.FAIL_IF_NOT_TRACKABLE) else 0));
    }
};
...
pub const LZOPENFILE_STYLE = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(LZOPENFILE_STYLE, (if (o.CANCEL == 1) @enumToInt(LZOPENFILE_STYLE.CANCEL) else 0) | (if (o.CREATE == 1) @enumToInt(LZOPENFILE_STYLE.CREATE) else 0) | (if (o.DELETE == 1) @enumToInt(LZOPENFILE_STYLE.DELETE) else 0) | (if (o.EXIST == 1) @enumToInt(LZOPENFILE_STYLE.EXIST) else 0) | (if (o.PARSE == 1) @enumToInt(LZOPENFILE_STYLE.PARSE) else 0) | (if (o.PROMPT == 1) @enumToInt(LZOPENFILE_STYLE.PROMPT) else 0) | (if (o.READ == 1) @enumToInt(LZOPENFILE_STYLE.READ) else 0) | (if (o.READWRITE == 1) @enumToInt(LZOPENFILE_STYLE.READWRITE) else 0) | (if (o.REOPEN == 1) @enumToInt(LZOPENFILE_STYLE.REOPEN) else 0) | (if (o.SHARE_DENY_NONE == 1) @enumToInt(LZOPENFILE_STYLE.SHARE_DENY_NONE) else 0) | (if (o.SHARE_DENY_READ == 1) @enumToInt(LZOPENFILE_STYLE.SHARE_DENY_READ) else 0) | (if (o.SHARE_DENY_WRITE == 1) @enumToInt(LZOPENFILE_STYLE.SHARE_DENY_WRITE) else 0) | (if (o.SHARE_EXCLUSIVE == 1) @enumToInt(LZOPENFILE_STYLE.SHARE_EXCLUSIVE) else 0) | (if (o.WRITE == 1) @enumToInt(LZOPENFILE_STYLE.WRITE) else 0) | (if (o.VERIFY == 1) @enumToInt(LZOPENFILE_STYLE.VERIFY) else 0));
    }
};
...
pub const REPLACE_FILE_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(REPLACE_FILE_FLAGS, (if (o.WRITE_THROUGH == 1) @enumToInt(REPLACE_FILE_FLAGS.WRITE_THROUGH) else 0) | (if (o.IGNORE_MERGE_ERRORS == 1) @enumToInt(REPLACE_FILE_FLAGS.IGNORE_MERGE_ERRORS) else 0) | (if (o.IGNORE_ACL_ERRORS == 1) @enumToInt(REPLACE_FILE_FLAGS.IGNORE_ACL_ERRORS) else 0));
    }
};
...
pub const LOCK_FILE_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(LOCK_FILE_FLAGS, (if (o.EXCLUSIVE_LOCK == 1) @enumToInt(LOCK_FILE_FLAGS.EXCLUSIVE_LOCK) else 0) | (if (o.FAIL_IMMEDIATELY == 1) @enumToInt(LOCK_FILE_FLAGS.FAIL_IMMEDIATELY) else 0));
    }
};
...
pub const FILE_INFO_FLAGS_PERMISSIONS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(FILE_INFO_FLAGS_PERMISSIONS, (if (o.READ == 1) @enumToInt(FILE_INFO_FLAGS_PERMISSIONS.READ) else 0) | (if (o.WRITE == 1) @enumToInt(FILE_INFO_FLAGS_PERMISSIONS.WRITE) else 0) | (if (o.CREATE == 1) @enumToInt(FILE_INFO_FLAGS_PERMISSIONS.CREATE) else 0));
    }
};
...
pub const SYMBOLIC_LINK_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(SYMBOLIC_LINK_FLAGS, (if (o.DIRECTORY == 1) @enumToInt(SYMBOLIC_LINK_FLAGS.DIRECTORY) else 0) | (if (o.ALLOW_UNPRIVILEGED_CREATE == 1) @enumToInt(SYMBOLIC_LINK_FLAGS.ALLOW_UNPRIVILEGED_CREATE) else 0));
    }
};
