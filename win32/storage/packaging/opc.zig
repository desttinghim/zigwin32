...
pub const OPC_READ_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(OPC_READ_FLAGS, (if (o.READ_DEFAULT == 1) @enumToInt(OPC_READ_FLAGS.READ_DEFAULT) else 0) | (if (o.VALIDATE_ON_LOAD == 1) @enumToInt(OPC_READ_FLAGS.VALIDATE_ON_LOAD) else 0) | (if (o.CACHE_ON_ACCESS == 1) @enumToInt(OPC_READ_FLAGS.CACHE_ON_ACCESS) else 0));
    }
};
...
pub const OPC_WRITE_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(OPC_WRITE_FLAGS, (if (o.DEFAULT == 1) @enumToInt(OPC_WRITE_FLAGS.DEFAULT) else 0) | (if (o.FORCE_ZIP32 == 1) @enumToInt(OPC_WRITE_FLAGS.FORCE_ZIP32) else 0));
    }
};
