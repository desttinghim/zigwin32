...
pub const APPX_CAPABILITIES = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(APPX_CAPABILITIES, (if (o.INTERNET_CLIENT == 1) @enumToInt(APPX_CAPABILITIES.INTERNET_CLIENT) else 0) | (if (o.INTERNET_CLIENT_SERVER == 1) @enumToInt(APPX_CAPABILITIES.INTERNET_CLIENT_SERVER) else 0) | (if (o.PRIVATE_NETWORK_CLIENT_SERVER == 1) @enumToInt(APPX_CAPABILITIES.PRIVATE_NETWORK_CLIENT_SERVER) else 0) | (if (o.DOCUMENTS_LIBRARY == 1) @enumToInt(APPX_CAPABILITIES.DOCUMENTS_LIBRARY) else 0) | (if (o.PICTURES_LIBRARY == 1) @enumToInt(APPX_CAPABILITIES.PICTURES_LIBRARY) else 0) | (if (o.VIDEOS_LIBRARY == 1) @enumToInt(APPX_CAPABILITIES.VIDEOS_LIBRARY) else 0) | (if (o.MUSIC_LIBRARY == 1) @enumToInt(APPX_CAPABILITIES.MUSIC_LIBRARY) else 0) | (if (o.ENTERPRISE_AUTHENTICATION == 1) @enumToInt(APPX_CAPABILITIES.ENTERPRISE_AUTHENTICATION) else 0) | (if (o.SHARED_USER_CERTIFICATES == 1) @enumToInt(APPX_CAPABILITIES.SHARED_USER_CERTIFICATES) else 0) | (if (o.REMOVABLE_STORAGE == 1) @enumToInt(APPX_CAPABILITIES.REMOVABLE_STORAGE) else 0) | (if (o.APPOINTMENTS == 1) @enumToInt(APPX_CAPABILITIES.APPOINTMENTS) else 0) | (if (o.CONTACTS == 1) @enumToInt(APPX_CAPABILITIES.CONTACTS) else 0));
    }
};
...
pub const APPX_ENCRYPTED_PACKAGE_OPTIONS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(APPX_ENCRYPTED_PACKAGE_OPTIONS, (if (o.NONE == 1) @enumToInt(APPX_ENCRYPTED_PACKAGE_OPTIONS.NONE) else 0) | (if (o.DIFFUSION == 1) @enumToInt(APPX_ENCRYPTED_PACKAGE_OPTIONS.DIFFUSION) else 0) | (if (o.PAGE_HASHING == 1) @enumToInt(APPX_ENCRYPTED_PACKAGE_OPTIONS.PAGE_HASHING) else 0));
    }
};
