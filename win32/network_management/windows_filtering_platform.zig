...
pub const IPSEC_POLICY_FLAG = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(IPSEC_POLICY_FLAG, (if (o.ND_SECURE == 1) @enumToInt(IPSEC_POLICY_FLAG.ND_SECURE) else 0) | (if (o.ND_BOUNDARY == 1) @enumToInt(IPSEC_POLICY_FLAG.ND_BOUNDARY) else 0) | (if (o.NAT_ENCAP_ALLOW_PEER_BEHIND_NAT == 1) @enumToInt(IPSEC_POLICY_FLAG.NAT_ENCAP_ALLOW_PEER_BEHIND_NAT) else 0) | (if (o.NAT_ENCAP_ALLOW_GENERAL_NAT_TRAVERSAL == 1) @enumToInt(IPSEC_POLICY_FLAG.NAT_ENCAP_ALLOW_GENERAL_NAT_TRAVERSAL) else 0) | (if (o.DONT_NEGOTIATE_SECOND_LIFETIME == 1) @enumToInt(IPSEC_POLICY_FLAG.DONT_NEGOTIATE_SECOND_LIFETIME) else 0) | (if (o.DONT_NEGOTIATE_BYTE_LIFETIME == 1) @enumToInt(IPSEC_POLICY_FLAG.DONT_NEGOTIATE_BYTE_LIFETIME) else 0) | (if (o.CLEAR_DF_ON_TUNNEL == 1) @enumToInt(IPSEC_POLICY_FLAG.CLEAR_DF_ON_TUNNEL) else 0) | (if (o.ENABLE_V6_IN_V4_TUNNELING == 1) @enumToInt(IPSEC_POLICY_FLAG.ENABLE_V6_IN_V4_TUNNELING) else 0) | (if (o.ENABLE_SERVER_ADDR_ASSIGNMENT == 1) @enumToInt(IPSEC_POLICY_FLAG.ENABLE_SERVER_ADDR_ASSIGNMENT) else 0) | (if (o.TUNNEL_ALLOW_OUTBOUND_CLEAR_CONNECTION == 1) @enumToInt(IPSEC_POLICY_FLAG.TUNNEL_ALLOW_OUTBOUND_CLEAR_CONNECTION) else 0) | (if (o.TUNNEL_BYPASS_ALREADY_SECURE_CONNECTION == 1) @enumToInt(IPSEC_POLICY_FLAG.TUNNEL_BYPASS_ALREADY_SECURE_CONNECTION) else 0) | (if (o.TUNNEL_BYPASS_ICMPV6 == 1) @enumToInt(IPSEC_POLICY_FLAG.TUNNEL_BYPASS_ICMPV6) else 0) | (if (o.KEY_MANAGER_ALLOW_DICTATE_KEY == 1) @enumToInt(IPSEC_POLICY_FLAG.KEY_MANAGER_ALLOW_DICTATE_KEY) else 0));
    }
};
pub const IPSEC_POLICY_FLAG_ND_SECURE = IPSEC_POLICY_FLAG.ND_SECURE;
pub const IPSEC_POLICY_FLAG_ND_BOUNDARY = IPSEC_POLICY_FLAG.ND_BOUNDARY;
pub const IPSEC_POLICY_FLAG_NAT_ENCAP_ALLOW_PEER_BEHIND_NAT = IPSEC_POLICY_FLAG.NAT_ENCAP_ALLOW_PEER_BEHIND_NAT;
pub const IPSEC_POLICY_FLAG_NAT_ENCAP_ALLOW_GENERAL_NAT_TRAVERSAL = IPSEC_POLICY_FLAG.NAT_ENCAP_ALLOW_GENERAL_NAT_TRAVERSAL;
pub const IPSEC_POLICY_FLAG_DONT_NEGOTIATE_SECOND_LIFETIME = IPSEC_POLICY_FLAG.DONT_NEGOTIATE_SECOND_LIFETIME;
pub const IPSEC_POLICY_FLAG_DONT_NEGOTIATE_BYTE_LIFETIME = IPSEC_POLICY_FLAG.DONT_NEGOTIATE_BYTE_LIFETIME;
pub const IPSEC_POLICY_FLAG_CLEAR_DF_ON_TUNNEL = IPSEC_POLICY_FLAG.CLEAR_DF_ON_TUNNEL;
pub const IPSEC_POLICY_FLAG_ENABLE_V6_IN_V4_TUNNELING = IPSEC_POLICY_FLAG.ENABLE_V6_IN_V4_TUNNELING;
pub const IPSEC_POLICY_FLAG_ENABLE_SERVER_ADDR_ASSIGNMENT = IPSEC_POLICY_FLAG.ENABLE_SERVER_ADDR_ASSIGNMENT;
pub const IPSEC_POLICY_FLAG_TUNNEL_ALLOW_OUTBOUND_CLEAR_CONNECTION = IPSEC_POLICY_FLAG.TUNNEL_ALLOW_OUTBOUND_CLEAR_CONNECTION;
pub const IPSEC_POLICY_FLAG_TUNNEL_BYPASS_ALREADY_SECURE_CONNECTION = IPSEC_POLICY_FLAG.TUNNEL_BYPASS_ALREADY_SECURE_CONNECTION;
...
pub const IKEEXT_PRESHARED_KEY_AUTHENTICATION_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(IKEEXT_PRESHARED_KEY_AUTHENTICATION_FLAGS, (if (o.LOCAL_AUTH_ONLY == 1) @enumToInt(IKEEXT_PRESHARED_KEY_AUTHENTICATION_FLAGS.LOCAL_AUTH_ONLY) else 0) | (if (o.REMOTE_AUTH_ONLY == 1) @enumToInt(IKEEXT_PRESHARED_KEY_AUTHENTICATION_FLAGS.REMOTE_AUTH_ONLY) else 0));
    }
};
...
pub const IKEEXT_POLICY_FLAG = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(IKEEXT_POLICY_FLAG, (if (o.DISABLE_DIAGNOSTICS == 1) @enumToInt(IKEEXT_POLICY_FLAG.DISABLE_DIAGNOSTICS) else 0) | (if (o.NO_MACHINE_LUID_VERIFY == 1) @enumToInt(IKEEXT_POLICY_FLAG.NO_MACHINE_LUID_VERIFY) else 0) | (if (o.NO_IMPERSONATION_LUID_VERIFY == 1) @enumToInt(IKEEXT_POLICY_FLAG.NO_IMPERSONATION_LUID_VERIFY) else 0) | (if (o.ENABLE_OPTIONAL_DH == 1) @enumToInt(IKEEXT_POLICY_FLAG.ENABLE_OPTIONAL_DH) else 0));
    }
};
pub const IKEEXT_POLICY_FLAG_DISABLE_DIAGNOSTICS = IKEEXT_POLICY_FLAG.DISABLE_DIAGNOSTICS;
pub const IKEEXT_POLICY_FLAG_NO_MACHINE_LUID_VERIFY = IKEEXT_POLICY_FLAG.NO_MACHINE_LUID_VERIFY;
...
pub const IKEEXT_CERT_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(IKEEXT_CERT_FLAGS, (if (o.ENABLE_ACCOUNT_MAPPING == 1) @enumToInt(IKEEXT_CERT_FLAGS.ENABLE_ACCOUNT_MAPPING) else 0) | (if (o.DISABLE_REQUEST_PAYLOAD == 1) @enumToInt(IKEEXT_CERT_FLAGS.DISABLE_REQUEST_PAYLOAD) else 0) | (if (o.USE_NAP_CERTIFICATE == 1) @enumToInt(IKEEXT_CERT_FLAGS.USE_NAP_CERTIFICATE) else 0) | (if (o.INTERMEDIATE_CA == 1) @enumToInt(IKEEXT_CERT_FLAGS.INTERMEDIATE_CA) else 0) | (if (o.IGNORE_INIT_CERT_MAP_FAILURE == 1) @enumToInt(IKEEXT_CERT_FLAGS.IGNORE_INIT_CERT_MAP_FAILURE) else 0) | (if (o.PREFER_NAP_CERTIFICATE_OUTBOUND == 1) @enumToInt(IKEEXT_CERT_FLAGS.PREFER_NAP_CERTIFICATE_OUTBOUND) else 0) | (if (o.SELECT_NAP_CERTIFICATE == 1) @enumToInt(IKEEXT_CERT_FLAGS.SELECT_NAP_CERTIFICATE) else 0) | (if (o.VERIFY_NAP_CERTIFICATE == 1) @enumToInt(IKEEXT_CERT_FLAGS.VERIFY_NAP_CERTIFICATE) else 0) | (if (o.FOLLOW_RENEWAL_CERTIFICATE == 1) @enumToInt(IKEEXT_CERT_FLAGS.FOLLOW_RENEWAL_CERTIFICATE) else 0));
    }
};
...
pub const IKEEXT_RESERVED_AUTHENTICATION_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(IKEEXT_RESERVED_AUTHENTICATION_FLAGS, (if (o.N == 1) @enumToInt(IKEEXT_RESERVED_AUTHENTICATION_FLAGS.N) else 0));
    }
};
...
pub const IKEEXT_EAP_AUTHENTICATION_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(IKEEXT_EAP_AUTHENTICATION_FLAGS, (if (o.LOCAL_AUTH_ONLY == 1) @enumToInt(IKEEXT_EAP_AUTHENTICATION_FLAGS.LOCAL_AUTH_ONLY) else 0) | (if (o.REMOTE_AUTH_ONLY == 1) @enumToInt(IKEEXT_EAP_AUTHENTICATION_FLAGS.REMOTE_AUTH_ONLY) else 0));
    }
};
