...
pub const CDS_TYPE = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(CDS_TYPE, (if (o.FULLSCREEN == 1) @enumToInt(CDS_TYPE.FULLSCREEN) else 0) | (if (o.GLOBAL == 1) @enumToInt(CDS_TYPE.GLOBAL) else 0) | (if (o.NORESET == 1) @enumToInt(CDS_TYPE.NORESET) else 0) | (if (o.RESET == 1) @enumToInt(CDS_TYPE.RESET) else 0) | (if (o.SET_PRIMARY == 1) @enumToInt(CDS_TYPE.SET_PRIMARY) else 0) | (if (o.TEST == 1) @enumToInt(CDS_TYPE.TEST) else 0) | (if (o.UPDATEREGISTRY == 1) @enumToInt(CDS_TYPE.UPDATEREGISTRY) else 0) | (if (o.VIDEOPARAMETERS == 1) @enumToInt(CDS_TYPE.VIDEOPARAMETERS) else 0) | (if (o.ENABLE_UNSAFE_MODES == 1) @enumToInt(CDS_TYPE.ENABLE_UNSAFE_MODES) else 0) | (if (o.DISABLE_UNSAFE_MODES == 1) @enumToInt(CDS_TYPE.DISABLE_UNSAFE_MODES) else 0) | (if (o.RESET_EX == 1) @enumToInt(CDS_TYPE.RESET_EX) else 0));
    }
};
...
pub const DRAWSTATE_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(DRAWSTATE_FLAGS, (if (o.T_COMPLEX == 1) @enumToInt(DRAWSTATE_FLAGS.T_COMPLEX) else 0) | (if (o.T_TEXT == 1) @enumToInt(DRAWSTATE_FLAGS.T_TEXT) else 0) | (if (o.T_PREFIXTEXT == 1) @enumToInt(DRAWSTATE_FLAGS.T_PREFIXTEXT) else 0) | (if (o.T_ICON == 1) @enumToInt(DRAWSTATE_FLAGS.T_ICON) else 0) | (if (o.T_BITMAP == 1) @enumToInt(DRAWSTATE_FLAGS.T_BITMAP) else 0) | (if (o.S_UNION == 1) @enumToInt(DRAWSTATE_FLAGS.S_UNION) else 0) | (if (o.S_DISABLED == 1) @enumToInt(DRAWSTATE_FLAGS.S_DISABLED) else 0) | (if (o.S_MONO == 1) @enumToInt(DRAWSTATE_FLAGS.S_MONO) else 0) | (if (o.S_HIDEPREFIX == 1) @enumToInt(DRAWSTATE_FLAGS.S_HIDEPREFIX) else 0) | (if (o.S_PREFIXONLY == 1) @enumToInt(DRAWSTATE_FLAGS.S_PREFIXONLY) else 0) | (if (o.S_RIGHT == 1) @enumToInt(DRAWSTATE_FLAGS.S_RIGHT) else 0));
    }
};
...
pub const TTEMBED_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(TTEMBED_FLAGS, (if (o.EMBEDEUDC == 1) @enumToInt(TTEMBED_FLAGS.EMBEDEUDC) else 0) | (if (o.RAW == 1) @enumToInt(TTEMBED_FLAGS.RAW) else 0) | (if (o.SUBSET == 1) @enumToInt(TTEMBED_FLAGS.SUBSET) else 0) | (if (o.TTCOMPRESSED == 1) @enumToInt(TTEMBED_FLAGS.TTCOMPRESSED) else 0));
    }
};
...
pub const GET_DCX_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(GET_DCX_FLAGS, (if (o.WINDOW == 1) @enumToInt(GET_DCX_FLAGS.WINDOW) else 0) | (if (o.CACHE == 1) @enumToInt(GET_DCX_FLAGS.CACHE) else 0) | (if (o.PARENTCLIP == 1) @enumToInt(GET_DCX_FLAGS.PARENTCLIP) else 0) | (if (o.CLIPSIBLINGS == 1) @enumToInt(GET_DCX_FLAGS.CLIPSIBLINGS) else 0) | (if (o.CLIPCHILDREN == 1) @enumToInt(GET_DCX_FLAGS.CLIPCHILDREN) else 0) | (if (o.NORESETATTRS == 1) @enumToInt(GET_DCX_FLAGS.NORESETATTRS) else 0) | (if (o.LOCKWINDOWUPDATE == 1) @enumToInt(GET_DCX_FLAGS.LOCKWINDOWUPDATE) else 0) | (if (o.EXCLUDERGN == 1) @enumToInt(GET_DCX_FLAGS.EXCLUDERGN) else 0) | (if (o.INTERSECTRGN == 1) @enumToInt(GET_DCX_FLAGS.INTERSECTRGN) else 0) | (if (o.INTERSECTUPDATE == 1) @enumToInt(GET_DCX_FLAGS.INTERSECTUPDATE) else 0) | (if (o.VALIDATE == 1) @enumToInt(GET_DCX_FLAGS.VALIDATE) else 0));
    }
};
...
pub const DC_LAYOUT = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(DC_LAYOUT, (if (o.BITMAPORIENTATIONPRESERVED == 1) @enumToInt(DC_LAYOUT.BITMAPORIENTATIONPRESERVED) else 0) | (if (o.RTL == 1) @enumToInt(DC_LAYOUT.RTL) else 0));
    }
};
...
pub const TTLOAD_EMBEDDED_FONT_STATUS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(TTLOAD_EMBEDDED_FONT_STATUS, (if (o.SUBSETTED == 1) @enumToInt(TTLOAD_EMBEDDED_FONT_STATUS.SUBSETTED) else 0) | (if (o.IN_SYSSTARTUP == 1) @enumToInt(TTLOAD_EMBEDDED_FONT_STATUS.IN_SYSSTARTUP) else 0));
    }
};
...
pub const DRAW_EDGE_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(DRAW_EDGE_FLAGS, (if (o.ADJUST == 1) @enumToInt(DRAW_EDGE_FLAGS.ADJUST) else 0) | (if (o.BOTTOM == 1) @enumToInt(DRAW_EDGE_FLAGS.BOTTOM) else 0) | (if (o.BOTTOMLEFT == 1) @enumToInt(DRAW_EDGE_FLAGS.BOTTOMLEFT) else 0) | (if (o.BOTTOMRIGHT == 1) @enumToInt(DRAW_EDGE_FLAGS.BOTTOMRIGHT) else 0) | (if (o.DIAGONAL == 1) @enumToInt(DRAW_EDGE_FLAGS.DIAGONAL) else 0) | (if (o.DIAGONAL_ENDBOTTOMLEFT == 1) @enumToInt(DRAW_EDGE_FLAGS.DIAGONAL_ENDBOTTOMLEFT) else 0) | (if (o.DIAGONAL_ENDBOTTOMRIGHT == 1) @enumToInt(DRAW_EDGE_FLAGS.DIAGONAL_ENDBOTTOMRIGHT) else 0) | (if (o.DIAGONAL_ENDTOPLEFT == 1) @enumToInt(DRAW_EDGE_FLAGS.DIAGONAL_ENDTOPLEFT) else 0) | (if (o.DIAGONAL_ENDTOPRIGHT == 1) @enumToInt(DRAW_EDGE_FLAGS.DIAGONAL_ENDTOPRIGHT) else 0) | (if (o.FLAT == 1) @enumToInt(DRAW_EDGE_FLAGS.FLAT) else 0) | (if (o.LEFT == 1) @enumToInt(DRAW_EDGE_FLAGS.LEFT) else 0) | (if (o.MIDDLE == 1) @enumToInt(DRAW_EDGE_FLAGS.MIDDLE) else 0) | (if (o.MONO == 1) @enumToInt(DRAW_EDGE_FLAGS.MONO) else 0) | (if (o.RECT == 1) @enumToInt(DRAW_EDGE_FLAGS.RECT) else 0) | (if (o.RIGHT == 1) @enumToInt(DRAW_EDGE_FLAGS.RIGHT) else 0) | (if (o.SOFT == 1) @enumToInt(DRAW_EDGE_FLAGS.SOFT) else 0) | (if (o.TOP == 1) @enumToInt(DRAW_EDGE_FLAGS.TOP) else 0) | (if (o.TOPLEFT == 1) @enumToInt(DRAW_EDGE_FLAGS.TOPLEFT) else 0) | (if (o.TOPRIGHT == 1) @enumToInt(DRAW_EDGE_FLAGS.TOPRIGHT) else 0));
    }
};
...
pub const DRAW_CAPTION_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(DRAW_CAPTION_FLAGS, (if (o.ACTIVE == 1) @enumToInt(DRAW_CAPTION_FLAGS.ACTIVE) else 0) | (if (o.BUTTONS == 1) @enumToInt(DRAW_CAPTION_FLAGS.BUTTONS) else 0) | (if (o.GRADIENT == 1) @enumToInt(DRAW_CAPTION_FLAGS.GRADIENT) else 0) | (if (o.ICON == 1) @enumToInt(DRAW_CAPTION_FLAGS.ICON) else 0) | (if (o.INBUTTON == 1) @enumToInt(DRAW_CAPTION_FLAGS.INBUTTON) else 0) | (if (o.SMALLCAP == 1) @enumToInt(DRAW_CAPTION_FLAGS.SMALLCAP) else 0) | (if (o.TEXT == 1) @enumToInt(DRAW_CAPTION_FLAGS.TEXT) else 0));
    }
};
