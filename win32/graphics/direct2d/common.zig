...
pub const D2D1_PATH_SEGMENT = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(D2D1_PATH_SEGMENT, (if (o.NONE == 1) @enumToInt(D2D1_PATH_SEGMENT.NONE) else 0) | (if (o.FORCE_UNSTROKED == 1) @enumToInt(D2D1_PATH_SEGMENT.FORCE_UNSTROKED) else 0) | (if (o.FORCE_ROUND_LINE_JOIN == 1) @enumToInt(D2D1_PATH_SEGMENT.FORCE_ROUND_LINE_JOIN) else 0) | (if (o.FORCE_DWORD == 1) @enumToInt(D2D1_PATH_SEGMENT.FORCE_DWORD) else 0));
    }
};
