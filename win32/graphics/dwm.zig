...
pub const DWM_TAB_WINDOW_REQUIREMENTS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(DWM_TAB_WINDOW_REQUIREMENTS, (if (o.NONE == 1) @enumToInt(DWM_TAB_WINDOW_REQUIREMENTS.NONE) else 0) | (if (o.IMPLEMENTED_BY_SYSTEM == 1) @enumToInt(DWM_TAB_WINDOW_REQUIREMENTS.IMPLEMENTED_BY_SYSTEM) else 0) | (if (o.WINDOW_RELATIONSHIP == 1) @enumToInt(DWM_TAB_WINDOW_REQUIREMENTS.WINDOW_RELATIONSHIP) else 0) | (if (o.WINDOW_STYLES == 1) @enumToInt(DWM_TAB_WINDOW_REQUIREMENTS.WINDOW_STYLES) else 0) | (if (o.WINDOW_REGION == 1) @enumToInt(DWM_TAB_WINDOW_REQUIREMENTS.WINDOW_REGION) else 0) | (if (o.WINDOW_DWM_ATTRIBUTES == 1) @enumToInt(DWM_TAB_WINDOW_REQUIREMENTS.WINDOW_DWM_ATTRIBUTES) else 0) | (if (o.WINDOW_MARGINS == 1) @enumToInt(DWM_TAB_WINDOW_REQUIREMENTS.WINDOW_MARGINS) else 0) | (if (o.TABBING_ENABLED == 1) @enumToInt(DWM_TAB_WINDOW_REQUIREMENTS.TABBING_ENABLED) else 0) | (if (o.USER_POLICY == 1) @enumToInt(DWM_TAB_WINDOW_REQUIREMENTS.USER_POLICY) else 0) | (if (o.GROUP_POLICY == 1) @enumToInt(DWM_TAB_WINDOW_REQUIREMENTS.GROUP_POLICY) else 0) | (if (o.APP_COMPAT == 1) @enumToInt(DWM_TAB_WINDOW_REQUIREMENTS.APP_COMPAT) else 0));
    }
};
