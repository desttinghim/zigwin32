...
pub const TOKEN_PRIVILEGES_ATTRIBUTES = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(TOKEN_PRIVILEGES_ATTRIBUTES, (if (o.ENABLED == 1) @enumToInt(TOKEN_PRIVILEGES_ATTRIBUTES.ENABLED) else 0) | (if (o.ENABLED_BY_DEFAULT == 1) @enumToInt(TOKEN_PRIVILEGES_ATTRIBUTES.ENABLED_BY_DEFAULT) else 0) | (if (o.REMOVED == 1) @enumToInt(TOKEN_PRIVILEGES_ATTRIBUTES.REMOVED) else 0) | (if (o.USED_FOR_ACCESS == 1) @enumToInt(TOKEN_PRIVILEGES_ATTRIBUTES.USED_FOR_ACCESS) else 0));
    }
};
...
pub const SYSTEM_AUDIT_OBJECT_ACE_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(SYSTEM_AUDIT_OBJECT_ACE_FLAGS, (if (o.OBJECT_TYPE_PRESENT == 1) @enumToInt(SYSTEM_AUDIT_OBJECT_ACE_FLAGS.OBJECT_TYPE_PRESENT) else 0) | (if (o.INHERITED_OBJECT_TYPE_PRESENT == 1) @enumToInt(SYSTEM_AUDIT_OBJECT_ACE_FLAGS.INHERITED_OBJECT_TYPE_PRESENT) else 0));
    }
};
