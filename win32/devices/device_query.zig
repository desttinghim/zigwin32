...
pub const DEVPROP_OPERATOR = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(DEVPROP_OPERATOR, (if (o.MODIFIER_NOT == 1) @enumToInt(DEVPROP_OPERATOR.MODIFIER_NOT) else 0) | (if (o.MODIFIER_IGNORE_CASE == 1) @enumToInt(DEVPROP_OPERATOR.MODIFIER_IGNORE_CASE) else 0) | (if (o.NONE == 1) @enumToInt(DEVPROP_OPERATOR.NONE) else 0) | (if (o.EXISTS == 1) @enumToInt(DEVPROP_OPERATOR.EXISTS) else 0) | (if (o.NOT_EXISTS == 1) @enumToInt(DEVPROP_OPERATOR.NOT_EXISTS) else 0) | (if (o.EQUALS == 1) @enumToInt(DEVPROP_OPERATOR.EQUALS) else 0) | (if (o.NOT_EQUALS == 1) @enumToInt(DEVPROP_OPERATOR.NOT_EQUALS) else 0) | (if (o.GREATER_THAN == 1) @enumToInt(DEVPROP_OPERATOR.GREATER_THAN) else 0) | (if (o.LESS_THAN == 1) @enumToInt(DEVPROP_OPERATOR.LESS_THAN) else 0) | (if (o.GREATER_THAN_EQUALS == 1) @enumToInt(DEVPROP_OPERATOR.GREATER_THAN_EQUALS) else 0) | (if (o.LESS_THAN_EQUALS == 1) @enumToInt(DEVPROP_OPERATOR.LESS_THAN_EQUALS) else 0) | (if (o.EQUALS_IGNORE_CASE == 1) @enumToInt(DEVPROP_OPERATOR.EQUALS_IGNORE_CASE) else 0) | (if (o.NOT_EQUALS_IGNORE_CASE == 1) @enumToInt(DEVPROP_OPERATOR.NOT_EQUALS_IGNORE_CASE) else 0) | (if (o.BITWISE_AND == 1) @enumToInt(DEVPROP_OPERATOR.BITWISE_AND) else 0) | (if (o.BITWISE_OR == 1) @enumToInt(DEVPROP_OPERATOR.BITWISE_OR) else 0) | (if (o.BEGINS_WITH == 1) @enumToInt(DEVPROP_OPERATOR.BEGINS_WITH) else 0) | (if (o.ENDS_WITH == 1) @enumToInt(DEVPROP_OPERATOR.ENDS_WITH) else 0) | (if (o.CONTAINS == 1) @enumToInt(DEVPROP_OPERATOR.CONTAINS) else 0) | (if (o.BEGINS_WITH_IGNORE_CASE == 1) @enumToInt(DEVPROP_OPERATOR.BEGINS_WITH_IGNORE_CASE) else 0) | (if (o.ENDS_WITH_IGNORE_CASE == 1) @enumToInt(DEVPROP_OPERATOR.ENDS_WITH_IGNORE_CASE) else 0) | (if (o.CONTAINS_IGNORE_CASE == 1) @enumToInt(DEVPROP_OPERATOR.CONTAINS_IGNORE_CASE) else 0) | (if (o.LIST_CONTAINS == 1) @enumToInt(DEVPROP_OPERATOR.LIST_CONTAINS) else 0) | (if (o.LIST_ELEMENT_BEGINS_WITH == 1) @enumToInt(DEVPROP_OPERATOR.LIST_ELEMENT_BEGINS_WITH) else 0) | (if (o.LIST_ELEMENT_ENDS_WITH == 1) @enumToInt(DEVPROP_OPERATOR.LIST_ELEMENT_ENDS_WITH) else 0) | (if (o.LIST_ELEMENT_CONTAINS == 1) @enumToInt(DEVPROP_OPERATOR.LIST_ELEMENT_CONTAINS) else 0) | (if (o.LIST_CONTAINS_IGNORE_CASE == 1) @enumToInt(DEVPROP_OPERATOR.LIST_CONTAINS_IGNORE_CASE) else 0) | (if (o.LIST_ELEMENT_BEGINS_WITH_IGNORE_CASE == 1) @enumToInt(DEVPROP_OPERATOR.LIST_ELEMENT_BEGINS_WITH_IGNORE_CASE) else 0) | (if (o.LIST_ELEMENT_ENDS_WITH_IGNORE_CASE == 1) @enumToInt(DEVPROP_OPERATOR.LIST_ELEMENT_ENDS_WITH_IGNORE_CASE) else 0) | (if (o.LIST_ELEMENT_CONTAINS_IGNORE_CASE == 1) @enumToInt(DEVPROP_OPERATOR.LIST_ELEMENT_CONTAINS_IGNORE_CASE) else 0) | (if (o.AND_OPEN == 1) @enumToInt(DEVPROP_OPERATOR.AND_OPEN) else 0) | (if (o.AND_CLOSE == 1) @enumToInt(DEVPROP_OPERATOR.AND_CLOSE) else 0) | (if (o.OR_OPEN == 1) @enumToInt(DEVPROP_OPERATOR.OR_OPEN) else 0) | (if (o.OR_CLOSE == 1) @enumToInt(DEVPROP_OPERATOR.OR_CLOSE) else 0) | (if (o.NOT_OPEN == 1) @enumToInt(DEVPROP_OPERATOR.NOT_OPEN) else 0) | (if (o.NOT_CLOSE == 1) @enumToInt(DEVPROP_OPERATOR.NOT_CLOSE) else 0) | (if (o.ARRAY_CONTAINS == 1) @enumToInt(DEVPROP_OPERATOR.ARRAY_CONTAINS) else 0) | (if (o.MASK_EVAL == 1) @enumToInt(DEVPROP_OPERATOR.MASK_EVAL) else 0) | (if (o.MASK_LIST == 1) @enumToInt(DEVPROP_OPERATOR.MASK_LIST) else 0) | (if (o.MASK_MODIFIER == 1) @enumToInt(DEVPROP_OPERATOR.MASK_MODIFIER) else 0) | (if (o.MASK_NOT_LOGICAL == 1) @enumToInt(DEVPROP_OPERATOR.MASK_NOT_LOGICAL) else 0) | (if (o.MASK_LOGICAL == 1) @enumToInt(DEVPROP_OPERATOR.MASK_LOGICAL) else 0) | (if (o.MASK_ARRAY == 1) @enumToInt(DEVPROP_OPERATOR.MASK_ARRAY) else 0));
    }
};
