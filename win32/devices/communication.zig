...
pub const MODEM_STATUS_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(MODEM_STATUS_FLAGS, (if (o.CTS_ON == 1) @enumToInt(MODEM_STATUS_FLAGS.CTS_ON) else 0) | (if (o.DSR_ON == 1) @enumToInt(MODEM_STATUS_FLAGS.DSR_ON) else 0) | (if (o.RING_ON == 1) @enumToInt(MODEM_STATUS_FLAGS.RING_ON) else 0) | (if (o.RLSD_ON == 1) @enumToInt(MODEM_STATUS_FLAGS.RLSD_ON) else 0));
    }
};
...
pub const CLEAR_COMM_ERROR_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(CLEAR_COMM_ERROR_FLAGS, (if (o.BREAK == 1) @enumToInt(CLEAR_COMM_ERROR_FLAGS.BREAK) else 0) | (if (o.FRAME == 1) @enumToInt(CLEAR_COMM_ERROR_FLAGS.FRAME) else 0) | (if (o.OVERRUN == 1) @enumToInt(CLEAR_COMM_ERROR_FLAGS.OVERRUN) else 0) | (if (o.RXOVER == 1) @enumToInt(CLEAR_COMM_ERROR_FLAGS.RXOVER) else 0) | (if (o.RXPARITY == 1) @enumToInt(CLEAR_COMM_ERROR_FLAGS.RXPARITY) else 0));
    }
};
...
pub const PURGE_COMM_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(PURGE_COMM_FLAGS, (if (o.RXABORT == 1) @enumToInt(PURGE_COMM_FLAGS.RXABORT) else 0) | (if (o.RXCLEAR == 1) @enumToInt(PURGE_COMM_FLAGS.RXCLEAR) else 0) | (if (o.TXABORT == 1) @enumToInt(PURGE_COMM_FLAGS.TXABORT) else 0) | (if (o.TXCLEAR == 1) @enumToInt(PURGE_COMM_FLAGS.TXCLEAR) else 0));
    }
};
...
pub const COMM_EVENT_MASK = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(COMM_EVENT_MASK, (if (o.BREAK == 1) @enumToInt(COMM_EVENT_MASK.BREAK) else 0) | (if (o.CTS == 1) @enumToInt(COMM_EVENT_MASK.CTS) else 0) | (if (o.DSR == 1) @enumToInt(COMM_EVENT_MASK.DSR) else 0) | (if (o.ERR == 1) @enumToInt(COMM_EVENT_MASK.ERR) else 0) | (if (o.EVENT1 == 1) @enumToInt(COMM_EVENT_MASK.EVENT1) else 0) | (if (o.EVENT2 == 1) @enumToInt(COMM_EVENT_MASK.EVENT2) else 0) | (if (o.PERR == 1) @enumToInt(COMM_EVENT_MASK.PERR) else 0) | (if (o.RING == 1) @enumToInt(COMM_EVENT_MASK.RING) else 0) | (if (o.RLSD == 1) @enumToInt(COMM_EVENT_MASK.RLSD) else 0) | (if (o.RX80FULL == 1) @enumToInt(COMM_EVENT_MASK.RX80FULL) else 0) | (if (o.RXCHAR == 1) @enumToInt(COMM_EVENT_MASK.RXCHAR) else 0) | (if (o.RXFLAG == 1) @enumToInt(COMM_EVENT_MASK.RXFLAG) else 0) | (if (o.TXEMPTY == 1) @enumToInt(COMM_EVENT_MASK.TXEMPTY) else 0));
    }
};
...
pub const MODEMDEVCAPS_DIAL_OPTIONS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(MODEMDEVCAPS_DIAL_OPTIONS, (if (o.BILLING == 1) @enumToInt(MODEMDEVCAPS_DIAL_OPTIONS.BILLING) else 0) | (if (o.DIALTONE == 1) @enumToInt(MODEMDEVCAPS_DIAL_OPTIONS.DIALTONE) else 0) | (if (o.QUIET == 1) @enumToInt(MODEMDEVCAPS_DIAL_OPTIONS.QUIET) else 0));
    }
};
...
pub const COMMPROP_STOP_PARITY = enum(u16) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(COMMPROP_STOP_PARITY, (if (o.STOPBITS_10 == 1) @enumToInt(COMMPROP_STOP_PARITY.STOPBITS_10) else 0) | (if (o.STOPBITS_15 == 1) @enumToInt(COMMPROP_STOP_PARITY.STOPBITS_15) else 0) | (if (o.STOPBITS_20 == 1) @enumToInt(COMMPROP_STOP_PARITY.STOPBITS_20) else 0) | (if (o.PARITY_NONE == 1) @enumToInt(COMMPROP_STOP_PARITY.PARITY_NONE) else 0) | (if (o.PARITY_ODD == 1) @enumToInt(COMMPROP_STOP_PARITY.PARITY_ODD) else 0) | (if (o.PARITY_EVEN == 1) @enumToInt(COMMPROP_STOP_PARITY.PARITY_EVEN) else 0) | (if (o.PARITY_MARK == 1) @enumToInt(COMMPROP_STOP_PARITY.PARITY_MARK) else 0) | (if (o.PARITY_SPACE == 1) @enumToInt(COMMPROP_STOP_PARITY.PARITY_SPACE) else 0));
    }
};
...
pub const MODEMDEVCAPS_SPEAKER_VOLUME = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(MODEMDEVCAPS_SPEAKER_VOLUME, (if (o.HIGH == 1) @enumToInt(MODEMDEVCAPS_SPEAKER_VOLUME.HIGH) else 0) | (if (o.LOW == 1) @enumToInt(MODEMDEVCAPS_SPEAKER_VOLUME.LOW) else 0) | (if (o.MEDIUM == 1) @enumToInt(MODEMDEVCAPS_SPEAKER_VOLUME.MEDIUM) else 0));
    }
};
...
pub const MODEMDEVCAPS_SPEAKER_MODE = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @intToEnum(MODEMDEVCAPS_SPEAKER_MODE, (if (o.CALLSETUP == 1) @enumToInt(MODEMDEVCAPS_SPEAKER_MODE.CALLSETUP) else 0) | (if (o.DIAL == 1) @enumToInt(MODEMDEVCAPS_SPEAKER_MODE.DIAL) else 0) | (if (o.OFF == 1) @enumToInt(MODEMDEVCAPS_SPEAKER_MODE.OFF) else 0) | (if (o.ON == 1) @enumToInt(MODEMDEVCAPS_SPEAKER_MODE.ON) else 0));
    }
};
